...
mod tests {
	...
	if cfg!(target_pointer_width = "64") {
	    overflowing_add_test!( isize, 0x7fffffff00000000, 0x00000000ffffffff, (0x7fffffffffffffff, false) );
	    overflowing_add_test!( isize, 0x7fffffffffffffff, 0x0000000000000001, (0x8000000000000000, true) );
	} else {
	    overflowing_add_test!( isize, 0x7fff0000, 0x0000ffff, (0x7fffffff, false) );
	    overflowing_add_test!( isize, 0x7fffffff, 0x00000001, (0x80000000, true) );
	}
    }
}
