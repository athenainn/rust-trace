...
mod tests {
	...
	is_positive_test!( 0x7fffffff, true );
	is_positive_test!( 0x00000001, true );
	is_positive_test!( 0x00000000, false );
	is_positive_test!( 0x80000000, false );
	is_positive_test!( 0xffffffff, false );
    }
}
