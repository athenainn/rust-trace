...
mod tests {
	...
	let (high, low): (u16, u16) = value.full_mul(other, carry);

	assert_eq!(high, 0x2c26);
	assert_eq!(low, 0x2f60);
	assert_eq!(0x2c262f60, 12345 * 60000);
    }
	...
	let value: u16 = 12345;
	let other: u16 = 60000;
	let carry: u16 = 0x1000;
	let (high, low): (u16, u16) = value.full_mul(other, carry);

	assert_eq!(high, 0x2c26);
	assert_eq!(low, 0x2f60 + 0x1000);
	assert_eq!(0x2c263f60, 12345 * 60000 + 0x1000);
    }
}
