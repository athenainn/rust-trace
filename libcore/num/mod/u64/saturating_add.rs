...
mod tests {
	...
	($value:expr, $other:expr, $result:expr) => ({
	    let x: u64 = $value;
	    let other: u64  = $other;
	    let result: u64 = x.saturating_add(other);
	...
	saturating_add_test!( 0xffffffff00000000, 0x00000000ffffffff, 0xffffffffffffffff );
	saturating_add_test!( 0xffffffffffffffff, 0x0000000000000001, 0xffffffffffffffff );
    }
}
