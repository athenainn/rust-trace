...
mod tests {
	...
	($value:expr, $rhs:expr, $result:expr) => ({
	    let x: u64 = $value;
	    let rhs: u64  = $rhs;
	    let result: u64 = x.wrapping_mul(rhs);
	...
	wrapping_mul_test!( 0xffffffffffffffff, 0x0000000000000001, 0xffffffffffffffff );
	wrapping_mul_test!( 0xffffffffffffffff, 0x0000000000000002, 0xfffffffffffffffe );
    }
}
