...
mod tests {
	...
	($value:expr, $rhs:expr, $result:expr) => ({
	    let x: i32 = $value;
	    let rhs: i32  = $rhs;
	    let result: i32 = x.wrapping_add(rhs);
	...
	wrapping_add_test!( 0x7fff0000, 0x0000ffff, 0x7ffffffff );
	wrapping_add_test!( 0x7fffffff, 0x00000001, 0x80000000 );
	wrapping_add_test!( 0x80000000, 0xffffffff, 0x7fffffff );
    }
}
