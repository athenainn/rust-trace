...
mod tests {
	...
	overflowing_shr_test!( u8, 0x80, 0, (0x80, false) );
	overflowing_shr_test!( u8, 0x80, 1, (0x40, false) );
	overflowing_shr_test!( u8, 0x80, 2, (0x20, false) );
	overflowing_shr_test!( u8, 0x80, 3, (0x10, false) );
	overflowing_shr_test!( u8, 0x80, 4, (0x08, false) );
	overflowing_shr_test!( u8, 0x80, 5, (0x04, false) );
	overflowing_shr_test!( u8, 0x80, 6, (0x02, false) );
	overflowing_shr_test!( u8, 0x80, 7, (0x01, false) );
    }

    #[test]
    #[should_panic]
    fn overflowing_shr_test2() {
	overflowing_shr_test!( u8, 0x80, 8, (0x00, true) );
    }
}
