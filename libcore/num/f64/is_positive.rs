#![feature(core, core_float, no_std)]
extern crate core;
...
mod tests {
	...
	let result: bool = value.is_sign_positive();

	assert_eq!(result, false);
    }

    #[test]
    fn is_positive_test2() {
	let value: f64 = 0.0;
	let result: bool = value.is_positive();

	assert_eq!(result, true);
    }

    #[test]
    fn is_positive_test3() {
