...
mod tests {
    ...
    #[test]
    fn next_code_point_reverse_test1() {
	let bytes: &[u8] = &[];
	let mut iter: slice::Iter<u8> = bytes.iter();
	let result: Option<u32> = next_code_point_reverse(&mut iter);
    ...
    #[test]
    fn next_code_point_reverse_test2() {
	let bytes: &[u8] = &[0b0111_1111];
	let mut iter: slice::Iter<u8> = bytes.iter();
	let next_code_point_reverse: Option<u32> = next_code_point_reverse(&mut iter);
	let result: u32 = next_code_point_reverse.unwrap();

	assert_eq!(result, 0b0111_1111);
    }

    #[test]
    fn next_code_point_reverse_test3() {
    ...
    #[test]
    fn next_code_point_reverse_test4() {
    ...
    #[test]
    fn next_code_point_reverse_test5() {
