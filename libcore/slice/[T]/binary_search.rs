...
mod tests {
    ...
    #[test]
    fn binary_search_test1() {
	let slice: &[T] = &[11, 12, 12, 13, 14, 15, 16];
	let x: &T = &15;
	let binary_search: Result<usize, usize> = slice.binary_search(x);
