...
mod tests {
	...
	if cfg!(target_pointer_width = "64") {
	    overflowing_sub_test!( isize, 0x7fffffff00000000, 0x00000000ffffffff, (0x7ffffffe00000001, false) );
	    overflowing_sub_test!( isize, 0x7fffffffffffffff, 0xffffffffffffffff, (0x8000000000000000, true) );
	    overflowing_sub_test!( isize, 0x8000000000000000, 0x0000000000000001, (0x7fffffffffffffff, true) );
	} else {
	    overflowing_sub_test!( isize, 0x7fff0000, 0x0000ffff, (0x7ffe0001, false) );
	    overflowing_sub_test!( isize, 0x7fffffff, 0xffffffff, (0x80000000, true) );
	    overflowing_sub_test!( isize, 0x80000000, 0x00000001, (0x7fffffff, true) );
	}
    }
}
