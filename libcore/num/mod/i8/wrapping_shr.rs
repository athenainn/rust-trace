...
mod tests {
	...
	($value:expr, $rhs:expr, $result:expr) => ({
	    let x: i8 = $value;
	    let rhs: u32  = $rhs;
	    let result: i8 = x.wrapping_shr(rhs);
	...
	wrapping_shr_test!( 0x80, 0, 0x80 );
	wrapping_shr_test!( 0x80, 1, 0xc0 );
	wrapping_shr_test!( 0x80, 2, 0xe0 );
	wrapping_shr_test!( 0x80, 3, 0xf0 );
	wrapping_shr_test!( 0x80, 4, 0xf8 );
	wrapping_shr_test!( 0x80, 5, 0xfc );
	wrapping_shr_test!( 0x80, 6, 0xfe );
	wrapping_shr_test!( 0x80, 7, 0xff );
	wrapping_shr_test!( 0x80, 8, 0x80 );
    }
}
