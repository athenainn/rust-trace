...
mod tests {
	...
	($value:expr, $n:expr, $result:expr) => ({
	    let value: i16 = $value;
	    let n: u32 = $n;
	    let result: i16 = value.rotate_right(n);
	...
	rotate_right_test!( 0x8000, 0, 0x8000 );
	rotate_right_test!( 0x8000, 1, 0x4000 );
	rotate_right_test!( 0x8000, 2, 0x2000 );
	rotate_right_test!( 0x8000, 3, 0x1000 );
	rotate_right_test!( 0x8000, 4, 0x0800 );
	rotate_right_test!( 0x8000, 5, 0x0400 );
	rotate_right_test!( 0x8000, 6, 0x0200 );
	rotate_right_test!( 0x8000, 7, 0x0100 );
	rotate_right_test!( 0x8000, 8, 0x0080 );
	rotate_right_test!( 0x8000, 9, 0x0040 );
	rotate_right_test!( 0x8000, 10, 0x0020 );
	rotate_right_test!( 0x8000, 11, 0x0010 );
	rotate_right_test!( 0x8000, 12, 0x0008 );
	rotate_right_test!( 0x8000, 13, 0x0004 );
	rotate_right_test!( 0x8000, 14, 0x0002 );
	rotate_right_test!( 0x8000, 15, 0x0001 );
	rotate_right_test!( 0x8000, 16, 0x8000 );
    }
}
