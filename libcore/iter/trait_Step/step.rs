...
mod tests {
	...
	let result: Option<A<T>> = a.step(&by);

	match result {
	    Some(v) => assert_eq!(v.index, 168),
	    None => assert!(false)
	}
    }
    ...
    #[test]
    fn step_test2() {
	assert_eq!(68usize.step(&100), Some::<usize>(168));
	assert_eq!(68u8.step(&100), Some::<u8>(168));
	assert_eq!(68u16.step(&100), Some::<u16>(168));
	assert_eq!(68u32.step(&100), Some::<u32>(168));

	assert_eq!(68u64.step(&100), Some::<u64>(168));
    }

    #[test]
    fn step_test3() {
	assert_eq!(68isize.step(&-100), Some::<isize>(-32));
	assert_eq!(68i8.step(&-100), Some::<i8>(-32));
	assert_eq!(68i16.step(&-100), Some::<i16>(-32));
	assert_eq!(68i32.step(&-100), Some::<i32>(-32));

	assert_eq!(68i64.step(&-100), Some::<i64>(-32));
    }
}
