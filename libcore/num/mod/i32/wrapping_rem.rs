...
mod tests {
	...
	($value:expr, $rhs:expr, $result:expr) => ({
	    let x: i32 = $value;
	    let rhs: i32  = $rhs;
	    let result: i32 = x.wrapping_rem(rhs);
	...
	let x: i32 = 68;
	let rhs: i32  = 0;
	let _: i32 = x.wrapping_rem(rhs); // panicked at 'attempted remainder with a divisor of zero'
    }

    #[test]
    #[allow(overflowing_literals)]
    fn wrapping_rem_test2() {
	wrapping_rem_test!( 0x7fffffff, 0x00000001, 0x00000000 );
	wrapping_rem_test!( 0x7fffffff, 0x00000002, 0x00000001 );
	wrapping_rem_test!( 0x7fffffff, 0x00000003, 0x00000001 );
	wrapping_rem_test!( 0x7fffffff, 0x00000004, 0x00000003 );
	wrapping_rem_test!( 0x80000000, 0xffffffff, 0x00000000 );
    }
}
