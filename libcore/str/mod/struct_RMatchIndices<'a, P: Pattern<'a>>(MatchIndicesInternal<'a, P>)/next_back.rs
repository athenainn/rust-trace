...
mod tests {
	...
	assert_eq!(result.next_back(), Some::<(usize, usize)>((21, 24)));
	assert_eq!(result.next_back(), Some::<(usize, usize)>((48, 51)));
	assert_eq!(result.next_back(), None::<(usize, usize)>);
    }
	...
	assert_eq!(result.next_back(), Some::<(usize, usize)>((9, 12)));
	assert_eq!(result.next_back(), Some::<(usize, usize)>((21, 24)));
	assert_eq!(result.next_back(), Some::<(usize, usize)>((24, 27)));
	assert_eq!(result.next_back(), Some::<(usize, usize)>((48, 51)));
	assert_eq!(result.next_back(), None::<(usize, usize)>);
    }
