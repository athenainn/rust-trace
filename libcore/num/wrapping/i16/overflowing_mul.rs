...
mod tests {
	...
	overflowing_mul_test!( i16, 0x7fff, 0x0001, (0x7fff, false) );
	overflowing_mul_test!( i16, 0x7fff, 0x0002, (0xfffe, true) );
	overflowing_mul_test!( i16, 0x8000, 0xffff, (0x8000, true) );
    }
}
