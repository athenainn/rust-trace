...
mod tests {
	...
	($value:expr, $rhs:expr, $result:expr) => ({
	    let x: u8 = $value;
	    let rhs: u32  = $rhs;
	    let result: u8 = x.wrapping_shr(rhs);
	...
	wrapping_shr_test!( 0x80, 1, 0x40 );
	wrapping_shr_test!( 0x80, 2, 0x20 );
	wrapping_shr_test!( 0x80, 3, 0x10 );
	wrapping_shr_test!( 0x80, 4, 0x08 );
	wrapping_shr_test!( 0x80, 5, 0x04 );
	wrapping_shr_test!( 0x80, 6, 0x02 );
	wrapping_shr_test!( 0x80, 7, 0x01 );
