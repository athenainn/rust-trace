...
mod tests {
	...
	assert_eq!(chunks.idx(6), Some::<&[T]>(&[16]));
	assert_eq!(chunks.idx(7), None::<&[T]>);
    }
	...
	assert_eq!(chunks.idx(3), Some::<&[T]>(&[16]));
	assert_eq!(chunks.idx(4), None::<&[T]>);
    }
	...
	assert_eq!(chunks.idx(2), Some::<&[T]>(&[16]));
	assert_eq!(chunks.idx(3), None::<&[T]>);
    }
	...
	assert_eq!(chunks.idx(1), Some::<&[T]>(&[14, 15, 16]));
	assert_eq!(chunks.idx(2), None::<&[T]>);
    }
	...
	assert_eq!(chunks.idx(1), Some::<&[T]>(&[15, 16]));
	assert_eq!(chunks.idx(2), None::<&[T]>);
    }
	...
	assert_eq!(chunks.idx(1), Some::<&[T]>(&[16]));
	assert_eq!(chunks.idx(2), None::<&[T]>);
    }
	...
	assert_eq!(chunks.idx(0), Some::<&[T]>(&[11, 12, 12, 13, 14, 15, 16]));
	assert_eq!(chunks.idx(1), None::<&[T]>);
    }
