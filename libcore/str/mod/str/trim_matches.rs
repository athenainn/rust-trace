...
mod tests {
    ...
    #[test]
    fn trim_matches_test2() {
	type P = char; // P: Pattern<'a>

	let x: &str = "-=<勤能補拙>=-";
	let pat: P = '-';
	let result: &str = x.trim_matches::<P>(pat);

	assert_eq!(result, "=<勤能補拙>=");
    }

    #[test]
    fn trim_matches_test3() {
