...
mod tests {
	...
	($value:expr, $n:expr, $result:expr) => ({
	    let value: i16 = $value;
	    let n: u32 = $n;
	    let result: i16 = value.rotate_left(n);
	...
	rotate_left_test!( 0x0001, 0, 0x0001 );
	rotate_left_test!( 0x0001, 1, 0x0002 );
	rotate_left_test!( 0x0001, 2, 0x0004 );
	rotate_left_test!( 0x0001, 3, 0x0008 );
	rotate_left_test!( 0x0001, 4, 0x0010 );
	rotate_left_test!( 0x0001, 5, 0x0020 );
	rotate_left_test!( 0x0001, 6, 0x0040 );
	rotate_left_test!( 0x0001, 7, 0x0080 );
	rotate_left_test!( 0x0001, 8, 0x0100 );
	rotate_left_test!( 0x0001, 9, 0x0200 );
	rotate_left_test!( 0x0001, 10, 0x0400 );
	rotate_left_test!( 0x0001, 11, 0x0800 );
	rotate_left_test!( 0x0001, 12, 0x1000 );
	rotate_left_test!( 0x0001, 13, 0x2000 );
	rotate_left_test!( 0x0001, 14, 0x4000 );
	rotate_left_test!( 0x0001, 15, 0x8000 );
	rotate_left_test!( 0x0001, 16, 0x0001 );
    }
}
