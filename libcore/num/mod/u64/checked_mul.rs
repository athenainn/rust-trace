...
mod tests {
	...
	($value:expr, $other:expr, $overflow:expr) => ({
	    let x: u64 = $value;
	    let other: u64  = $other;
	    let result: Option<u64> = x.checked_mul(other);
	...
	checked_mul_test!( 0xffffffffffffffff, 0x0000000000000001, Some::<u64>(0xffffffffffffffff) );
	checked_mul_test!( 0xffffffffffffffff, 0x0000000000000002, None::<u64> );
    }
}
