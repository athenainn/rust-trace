...
mod tests {
	...
	($value:expr, $rhs:expr, $result:expr) => ({
	    let x: i32 = $value;
	    let rhs: i32  = $rhs;
	    let result: i32 = x.wrapping_div(rhs);
	...
	let x: i32 = 68;
	let rhs: i32  = 0;
	let _: i32 = x.wrapping_div(rhs); // panicked at 'attempted to divide by zero'
    }

    #[test]
    #[allow(overflowing_literals)]
    fn wrapping_div_test2() {
	wrapping_div_test!( 0x7fffffff, 0x00000001, 0x7fffffff );
	wrapping_div_test!( 0x7fffffff, 0xffffffff, 0x80000001 );
	wrapping_div_test!( 0x80000000, 0xffffffff, 0x80000000 );
    }
}
