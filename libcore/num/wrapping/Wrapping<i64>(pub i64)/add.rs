...
mod tests {
    ...
    #[test]
    fn add_test1() {
	add_test!( i64, 0x7fffffff00000000, 0x00000000ffffffff, 0x7fffffffffffffff );
    }

    #[test]
    #[allow(overflowing_literals)]
    fn add_test2() {
	add_test!( i64, 0x7fffffffffffffff, 0x0000000000000001, 0x8000000000000000 );
    }

    #[test]
    #[allow(overflowing_literals)]
    fn add_test3() {
	add_test!( i64, 0x8000000000000000, 0xffffffffffffffff, 0x7fffffffffffffff );
    }
}
