...
mod tests {
    ...
    #[test]
    fn char_range_at_reverse_test1() {
	let x: &str = "精誠";

	assert_eq!(x.len(), 6);

	for start in 0..4 {
	    let result: CharRange = x.char_range_at_reverse(start);
    ...
    #[test]
    #[should_panic]
    fn char_range_at_reverse_test2() {
	let x: &str = "精誠";
	let _: CharRange = x.char_range_at_reverse(7); // panicked at 'index out of bounds: the len is 6 but the index is 6'
    }
}
