...
mod tests {
	...
	($value:expr, $other:expr, $result:expr) => ({
	    let x: i32 = $value;
	    let other: i32  = $other;
	    let result: i32 = x.saturating_add(other);
	...
	saturating_add_test!( 0x7fff0000, 0x0000ffff, 0x7fffffff );
	saturating_add_test!( 0x7fffffff, 0x00000001, 0x7fffffff );
	saturating_add_test!( 0x80000000, 0xffffffff, 0x80000000 );
    }
}
