...
mod tests {
	...
	($value:expr, $rhs:expr, $result:expr) => ({
	    let x: u16 = $value;
	    let rhs: u16  = $rhs;
	    let result: u16 = x.wrapping_rem(rhs);
	...
	let x: u16 = 68;
	let rhs: u16  = 0;
	let _: u16 = x.wrapping_rem(rhs); // panicked at 'attempted remainder with a divisor of zero'
    }

    #[test]
    fn wrapping_rem_test2() {
	wrapping_rem_test!( 0xffff, 0x0001, 0x0000 );
	wrapping_rem_test!( 0xffff, 0x0002, 0x0001 );
	wrapping_rem_test!( 0xffff, 0x0003, 0x0000 );
	wrapping_rem_test!( 0xffff, 0x0004, 0x0003 );
    }
}
