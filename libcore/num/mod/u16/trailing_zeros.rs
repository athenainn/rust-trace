...
mod tests {
	...
	trailing_zeros_test!( 0x0000, 16 );
	trailing_zeros_test!( 0x0001, 0 );
	trailing_zeros_test!( 0x0002, 1 );
	trailing_zeros_test!( 0x0004, 2 );
	trailing_zeros_test!( 0x0008, 3 );
	trailing_zeros_test!( 0x0010, 4 );
	trailing_zeros_test!( 0x0020, 5 );
	trailing_zeros_test!( 0x0040, 6 );
	trailing_zeros_test!( 0x0080, 7 );
	trailing_zeros_test!( 0x0100, 8 );
	trailing_zeros_test!( 0x0200, 9 );
	trailing_zeros_test!( 0x0400, 10 );
	trailing_zeros_test!( 0x0800, 11 );
	trailing_zeros_test!( 0x1000, 12 );
	trailing_zeros_test!( 0x2000, 13 );
	trailing_zeros_test!( 0x4000, 14 );
	trailing_zeros_test!( 0x8000, 15 );
    }
}
