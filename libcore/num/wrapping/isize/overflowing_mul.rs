...
mod tests {
	...
	($T:ty, $value:expr, $rhs:expr, $result:expr) => ({
	    let value: $T = $value;
	    let rhs: $T = $rhs;
	    let result: ($T, bool) = value.overflowing_mul(rhs);
	...
	if cfg!(target_pointer_width = "64") {
	    overflowing_mul_test!( isize, 0x7fffffffffffffff, 0x0000000000000001, (0x7fffffffffffffff, false) );
	    overflowing_mul_test!( isize, 0x7fffffffffffffff, 0x0000000000000002, (0xfffffffffffffffe, true) );
	    overflowing_mul_test!( isize, 0x8000000000000000, 0xffffffffffffffff, (0x8000000000000000, true) );
	} else {
	    overflowing_mul_test!( isize, 0x7fffffff, 0x00000001, (0x7fffffff, false) );
	    overflowing_mul_test!( isize, 0x7fffffff, 0x00000002, (0xfffffffe, true) );
	    overflowing_mul_test!( isize, 0x80000000, 0xffffffff, (0x80000000, true) );
	}
    }
}
