...
mod tests {
    ...
    #[test]
    fn count_ones_test1() {
	count_ones_test!( 0x0000, 0 );
	count_ones_test!( 0x0001, 1 );
	count_ones_test!( 0x0003, 2 );
	count_ones_test!( 0x0007, 3 );
	count_ones_test!( 0x000f, 4 );
	count_ones_test!( 0x001f, 5 );
	count_ones_test!( 0x003f, 6 );
	count_ones_test!( 0x007f, 7 );
	count_ones_test!( 0x00ff, 8 );
	count_ones_test!( 0x01ff, 9 );
	count_ones_test!( 0x03ff, 10 );
	count_ones_test!( 0x07ff, 11 );
	count_ones_test!( 0x0fff, 12 );
	count_ones_test!( 0x1fff, 13 );
	count_ones_test!( 0x3fff, 14 );
	count_ones_test!( 0x7fff, 15 );
	count_ones_test!( 0xffff, 16 );
    }
}
