...
mod tests {
    ...
    macro_rules! saturating_add_test {
	($value:expr, $other:expr, $result:expr) => ({
	    let x: i64 = $value;
	    let other: i64  = $other;
	    let result: i64 = x.saturating_add(other);
    ...
    fn saturating_add_test1() {
	saturating_add_test!( 0x7fffffff00000000, 0x00000000ffffffff, 0x7fffffffffffffff );
	saturating_add_test!( 0x7fffffffffffffff, 0x0000000000000001, 0x7fffffffffffffff );
	saturating_add_test!( 0x8000000000000000, 0xffffffffffffffff, 0x8000000000000000 );
    }
}
