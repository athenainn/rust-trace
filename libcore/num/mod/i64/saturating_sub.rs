...
mod tests {
    ...
    macro_rules! saturating_sub_test {
	($value:expr, $other:expr, $result:expr) => ({
	    let x: i64 = $value;
	    let other: i64  = $other;
	    let result: i64 = x.saturating_sub(other);
    ...
    fn saturating_sub_test1() {
	saturating_sub_test!( 0x7fffffff00000000, 0x00000000ffffffff, 0x7ffffffe00000001 );
	saturating_sub_test!( 0x7fffffffffffffff, 0xffffffffffffffff, 0x7fffffffffffffff );
	saturating_sub_test!( 0x8000000000000000, 0x0000000000000001, 0x8000000000000000 );
    }
}
