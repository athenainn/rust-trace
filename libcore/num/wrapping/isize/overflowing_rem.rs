...
mod tests {
	...
	if cfg!(target_pointer_width = "64") {
	    overflowing_rem_test!( isize, 0x7fffffffffffffff, 0x0000000000000000, (0x7fffffffffffffff, false) ); // panicked at 'attempted remainder with a divisor of zero'
	} else {
	    overflowing_rem_test!( isize, 0x7fffffff, 0x00000000, (0x7fffffff, false) ); // panicked at 'attempted remainder with a divisor of zero'
	}
    }

    #[test]
    #[allow(overflowing_literals)]
    fn overflowing_neg_test2() {
	if cfg!(target_pointer_width = "64") {
	    overflowing_rem_test!( isize, 0x7fffffffffffffff, 0x0000000000000001, (0x0000000000000000, false) );
	    overflowing_rem_test!( isize, 0x7fffffffffffffff, 0x0000000000000002, (0x0000000000000001, false) );
	    overflowing_rem_test!( isize, 0x7fffffffffffffff, 0x0000000000000003, (0x0000000000000001, false) );
	    overflowing_rem_test!( isize, 0x7fffffffffffffff, 0x0000000000000004, (0x0000000000000003, false) );
	    overflowing_rem_test!( isize, 0x8000000000000000, 0xffffffffffffffff, (0x0000000000000000, true) );
	} else {
	    overflowing_rem_test!( isize, 0x7fffffff, 0x00000001, (0x00000000, false) );
	    overflowing_rem_test!( isize, 0x7fffffff, 0x00000002, (0x00000001, false) );
	    overflowing_rem_test!( isize, 0x7fffffff, 0x00000003, (0x00000001, false) );
	    overflowing_rem_test!( isize, 0x7fffffff, 0x00000004, (0x00000003, false) );
	    overflowing_rem_test!( isize, 0x80000000, 0xffffffff, (0x00000000, true) );
	}
    }
}
