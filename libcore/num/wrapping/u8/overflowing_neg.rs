...
mod tests {
	...
	overflowing_neg_test!( u8, 0x00, (0x00, always_true) );
	overflowing_neg_test!( u8, 0x01, (0xff, always_true) );
	overflowing_neg_test!( u8, 0x02, (0xfe, always_true) );
	overflowing_neg_test!( u8, 0x7f, (0x81, always_true) );
	overflowing_neg_test!( u8, 0x80, (0x80, always_true) );
    }
}
