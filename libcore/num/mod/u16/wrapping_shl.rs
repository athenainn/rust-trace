...
mod tests {
	...
	($value:expr, $rhs:expr, $result:expr) => ({
	    let x: u16 = $value;
	    let rhs: u32  = $rhs;
	    let result: u16 = x.wrapping_shl(rhs);
	...
	wrapping_shl_test!( 0x0001, 0, 0x0001 );
	wrapping_shl_test!( 0x0001, 1, 0x0002 );
	wrapping_shl_test!( 0x0001, 2, 0x0004 );
	wrapping_shl_test!( 0x0001, 3, 0x0008 );
	wrapping_shl_test!( 0x0001, 4, 0x0010 );
	wrapping_shl_test!( 0x0001, 5, 0x0020 );
	wrapping_shl_test!( 0x0001, 6, 0x0040 );
	wrapping_shl_test!( 0x0001, 7, 0x0080 );
	wrapping_shl_test!( 0x0001, 8, 0x0100 );
	wrapping_shl_test!( 0x0001, 9, 0x0200 );
	wrapping_shl_test!( 0x0001, 10, 0x0400 );
	wrapping_shl_test!( 0x0001, 11, 0x0800 );
	wrapping_shl_test!( 0x0001, 12, 0x1000 );
	wrapping_shl_test!( 0x0001, 13, 0x2000 );
	wrapping_shl_test!( 0x0001, 14, 0x4000 );
	wrapping_shl_test!( 0x0001, 15, 0x8000 );
	wrapping_shl_test!( 0x0001, 16, 0x0001 );
    }
}
