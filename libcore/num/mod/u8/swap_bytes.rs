...
mod tests {
	...
	($value:expr, $reverse:expr) => ({
	    let value: u8 = $value;
	    let result: u8 = value.swap_bytes();
    ...
    #[test]
    fn swap_bytes_test1() {
	swap_bytes_test!( 0x01, 0x01 );
	swap_bytes_test!( 0x02, 0x02 );
	swap_bytes_test!( 0x04, 0x04 );
	swap_bytes_test!( 0x08, 0x08 );
	swap_bytes_test!( 0x10, 0x10 );
	swap_bytes_test!( 0x20, 0x20 );
	swap_bytes_test!( 0x40, 0x40 );
	swap_bytes_test!( 0x80, 0x80 );
    }
}
