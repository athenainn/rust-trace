...
mod tests {
	...
	($value:expr, $rhs:expr, $result:expr) => ({
	    let x: u64 = $value;
	    let rhs: u64  = $rhs;
	    let result: u64 = x.wrapping_rem(rhs);
	...
	let x: u64 = 68;
	let rhs: u64  = 0;
	let _: u64 = x.wrapping_rem(rhs); // panicked at 'attempted remainder with a divisor of zero'
    }

    #[test]
    fn wrapping_rem_test2() {
	wrapping_rem_test!( 0xffffffffffffffff, 0x0000000000000001, 0x0000000000000000 );
	wrapping_rem_test!( 0xffffffffffffffff, 0x0000000000000002, 0x0000000000000001 );
	wrapping_rem_test!( 0xffffffffffffffff, 0x0000000000000003, 0x0000000000000000 );
	wrapping_rem_test!( 0xffffffffffffffff, 0x0000000000000004, 0x0000000000000003 );
    }
}
