...
mod tests {
	...
	($value:expr, $other:expr, $overflow:expr) => ({
	    let x: i32 = $value;
	    let other: i32  = $other;
	    let result: Option<i32> = x.checked_mul(other);
	...
	checked_mul_test!( 0x7fffffff, 0x00000001, Some::<i32>(0x7fffffff) );
	checked_mul_test!( 0x7fffffff, 0x00000002, None::<i32> );

	checked_mul_test!( 0x7fffffff, 0xffffffff, Some::<i32>(0x80000001) );
	checked_mul_test!( 0x80000000, 0xffffffff, None::<i32> );
    }
}
