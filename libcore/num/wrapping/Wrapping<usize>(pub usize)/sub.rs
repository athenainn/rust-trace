...
mod tests {
	...
	if cfg!(target_pointer_width = "64") {
	    sub_test!( usize, 0xffffffff00000000, 0x00000000ffffffff, 0xfffffffe00000001 );
	} else {
	    sub_test!( usize, 0xffff0000, 0x0000ffff, 0xfffe0001 );
	}
    }
    ...
    fn sub_test2() {
	if cfg!(target_pointer_width = "64") {
	    sub_test!( usize, 0x0000000000000000, 0x0000000000000001, 0xffffffffffffffff );
	} else {
	    sub_test!( usize, 0x00000000, 0x00000001, 0xffffffff );
	}
    }
}
