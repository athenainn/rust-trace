...
#[cfg(test)]
mod tests {
    use core::intrinsics::atomic_fence_acqrel;
    ...
    macro_rules! atomic_fence_acqrel_test {
    ...
    #[test]
    fn atomic_fence_acqrel_test1() {
	atomic_fence_acqrel_test!( 68, 500, 500 );
    }
}
