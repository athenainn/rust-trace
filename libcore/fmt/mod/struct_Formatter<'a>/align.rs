...
mod tests {
    ...
    use core::fmt::Result;
    use core::fmt::rt::v1::Alignment::{self, Left, Right, Center, Unknown};
	...
	fn fmt(&self, fmt: &mut Formatter) -> Result {
	    let align: Alignment = fmt.align();
	    let msg: &'static str = match align {
		Left => "Left",
		Right => "Right",
		Center => "Center",
		Unknown => "Unknown"
	...
	assert_eq!(output, "Unknown".to_string());
    }
	...
	assert_eq!(output, "Center".to_string());
    }
}
