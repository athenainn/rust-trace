...
mod tests {
	...
	assert_eq!(array_a.ne(&array_b), false);
	...
	assert_eq!(array_a.ne(&*slice_b), false);
	assert_eq!(array_a != *slice_b, false);

	assert_eq!((*slice_b).ne(&array_a), false);
	assert_eq!((*slice_b) != array_a, false);
    }
