...
mod tests {
	...
	assert_eq!(result.next(), Some::<&str>("倒吐葡萄皮"));
	assert_eq!(result.next(), Some::<&str>("不吐葡萄皮不"));
	...
	assert_eq!(result.next(), Some::<&str>("葡萄倒吐葡萄皮"));
	assert_eq!(result.next(), Some::<&str>("葡萄不吐葡萄皮不"));
	assert_eq!(result.next(), Some::<&str>(""));
	assert_eq!(result.next(), None::<&str>);
    }
