...
mod tests {
	...
	($T:ty, $value:expr, $other:expr, $result:expr) => ({
	    ...
	    let result: Wrapping<$T> = wrapping_value.bitand(wrapping_other);
	...
	if cfg!(target_pointer_width = "64") {
	    bitand_test!( isize, 0xe7e7e7e7e7e7e7e7, 0x7e7e7e7e7e7e7e7e, 0x6666666666666666 );
	} else {
	    bitand_test!( isize, 0xe7e7e7e7, 0x7e7e7e7e, 0x66666666 );
	}
    }
}
