...
mod tests {
	...
	let pat: P = "葡萄皮";
	let mut rmatches: RMatches<P> = x.rmatches::<P>(pat);
	let mut clone: RMatches<P> = rmatches.clone();

	assert_eq!(rmatches.next(), Some::<&str>("葡萄皮"));
	assert_eq!(rmatches.next(), Some::<&str>("葡萄皮"));
	assert_eq!(rmatches.next(), None::<&str>);

	assert_eq!(clone.next(), Some::<&str>("葡萄皮"));
	assert_eq!(clone.next(), Some::<&str>("葡萄皮"));
	...
	assert_eq!(rmatches.next(), Some::<&str>("皮"));
	assert_eq!(rmatches.next(), Some::<&str>("皮"));
	assert_eq!(rmatches.next(), None::<&str>);

	assert_eq!(clone.next(), Some::<&str>("皮"));
	assert_eq!(clone.next(), Some::<&str>("皮"));
	assert_eq!(clone.next(), None::<&str>);
    }
	...
	assert_eq!(rmatches.next(), Some::<&str>("皮"));
	assert_eq!(rmatches.next(), Some::<&str>("不"));
	assert_eq!(rmatches.next(), Some::<&str>("皮"));
	assert_eq!(rmatches.next(), Some::<&str>("不"));
	assert_eq!(rmatches.next(), None::<&str>);
