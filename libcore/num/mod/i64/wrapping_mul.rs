...
mod tests {
    ...
    macro_rules! wrapping_mul_test {
	($value:expr, $rhs:expr, $result:expr) => ({
	    let x: i64 = $value;
	    let rhs: i64  = $rhs;
	    let result: i64 = x.wrapping_mul(rhs);
    ...
    fn wrapping_mul_test1() {
	wrapping_mul_test!( 0x7fffffffffffffff, 0x0000000000000001, 0x7fffffffffffffff );
	wrapping_mul_test!( 0x7fffffffffffffff, 0xffffffffffffffff, 0x8000000000000001 );
	wrapping_mul_test!( 0x8000000000000000, 0xffffffffffffffff, 0x8000000000000000 );
    }
}
