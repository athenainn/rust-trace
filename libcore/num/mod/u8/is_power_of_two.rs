...
mod tests {
	...
	is_power_of_two_test!( 0x01, true );
	is_power_of_two_test!( 0x02, true );
	is_power_of_two_test!( 0x04, true );
	is_power_of_two_test!( 0x08, true );
	is_power_of_two_test!( 0x10, true );
	is_power_of_two_test!( 0x20, true );
	is_power_of_two_test!( 0x40, true );
	is_power_of_two_test!( 0x80, true );
    }
}
