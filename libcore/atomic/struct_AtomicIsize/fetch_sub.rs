...
mod tests {
	...
	($init:expr, $val:expr, $order:ident, $result:expr) => ({
		...
		let result: isize = clone.fetch_sub(val, $order);
		assert_eq!(result, $init);
	    });
    ...
    #[test]
    fn fetch_sub_test1() {
	fetch_sub_test!( 0, 0, Relaxed, 0 );
	fetch_sub_test!( 0, 0, Release, 0 );
	fetch_sub_test!( 0, 0, Acquire, 0 );
	fetch_sub_test!( 0, 0, AcqRel, 0 );
	fetch_sub_test!( 0, 0, SeqCst, 0 );
    }

    #[test]
    fn fetch_sub_test2() {
	fetch_sub_test!( 0, !0, Relaxed, 1 );
	fetch_sub_test!( 0, !0, Release, 1 );
	fetch_sub_test!( 0, !0, Acquire, 1 );
	fetch_sub_test!( 0, !0, AcqRel, 1 );
	fetch_sub_test!( 0, !0, SeqCst, 1 );
    }
