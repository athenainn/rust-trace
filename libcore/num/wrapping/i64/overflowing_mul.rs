...
mod tests {
	...
	overflowing_mul_test!( i64, 0x7fffffffffffffff, 0x0000000000000001, (0x7fffffffffffffff, false) );
	overflowing_mul_test!( i64, 0x7fffffffffffffff, 0x0000000000000002, (0xfffffffffffffffe, true) );
	overflowing_mul_test!( i64, 0x8000000000000000, 0xffffffffffffffff, (0x8000000000000000, true) );
    }
}
