...
mod tests {
	...
	fn fmt(&self, fmt: &mut Formatter) -> Result {
	    ...
	    let mut debugtuple: DebugTuple = fmt.debug_tuple(name);

	    let debugtuple_refmut: &mut DebugTuple = debugtuple.field(&self.0);
	    let result: Result = debugtuple_refmut.finish();
	...
	assert_eq!(output, "A(68)".to_string());
    }
