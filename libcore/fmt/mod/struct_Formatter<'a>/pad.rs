...
mod tests {
    ...
    fn pad_test2() {
	let a: A<f32> = A::new();
	let output: String = format!("{:.6}", a); // format with precision
    ...
    fn pad_test3() {
	let a: A<f32> = A::new();
	let output: String = format!("{:.15}", a); // format with precision
    ...
    fn pad_test4() {
	let a: A<u32> = A::new();
	let output: String = format!("{:15x}", a); // format with width
    ...
    fn pad_test5() {
	let a: A<u32> = A::new();
	let output: String = format!("{:6x}", a); // format with width
