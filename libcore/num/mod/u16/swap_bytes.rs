...
mod tests {
	...
	($value:expr, $reverse:expr) => ({
	    let value: u16 = $value;
	    let result: u16 = value.swap_bytes();
    ...
    #[test]
    fn swap_bytes_test1() {
	swap_bytes_test!( 0x0001, 0x0100 );
	swap_bytes_test!( 0x0002, 0x0200 );
	swap_bytes_test!( 0x0004, 0x0400 );
	swap_bytes_test!( 0x0008, 0x0800 );
	swap_bytes_test!( 0x0010, 0x1000 );
	swap_bytes_test!( 0x0020, 0x2000 );
	swap_bytes_test!( 0x0040, 0x4000 );
	swap_bytes_test!( 0x0080, 0x8000 );
	swap_bytes_test!( 0x0100, 0x0001 );
	swap_bytes_test!( 0x0200, 0x0002 );
	swap_bytes_test!( 0x0400, 0x0004 );
	swap_bytes_test!( 0x0800, 0x0008 );
	swap_bytes_test!( 0x1000, 0x0010 );
	swap_bytes_test!( 0x2000, 0x0020 );
	swap_bytes_test!( 0x4000, 0x0040 );
	swap_bytes_test!( 0x8000, 0x0080 );
    }
}
