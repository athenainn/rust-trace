...
mod tests {
	...
	let pat: P = "葡萄皮";
	let mut split_terminator: SplitTerminator<P> = x.split_terminator::<P>(pat);
	let mut clone: SplitTerminator<P> = split_terminator.clone();

	assert_eq!(split_terminator.next(), Some::<&str>("吃葡萄不吐"));
	assert_eq!(split_terminator.next(), Some::<&str>("不吃葡萄倒吐"));
	assert_eq!(split_terminator.next(), None::<&str>);
	...
	assert_eq!(split_terminator.next(), Some::<&str>("吃葡萄不吐葡萄"));
	assert_eq!(split_terminator.next(), Some::<&str>("不吃葡萄倒吐葡萄"));
	assert_eq!(split_terminator.next(), None::<&str>);
	...
	assert_eq!(split_terminator.next(), Some::<&str>("吃葡萄"));
	assert_eq!(split_terminator.next(), Some::<&str>("吐葡萄"));
	assert_eq!(split_terminator.next(), Some::<&str>(""));
	assert_eq!(split_terminator.next(), Some::<&str>("吃葡萄倒吐葡萄"));
	assert_eq!(split_terminator.next(), None::<&str>);

	assert_eq!(clone.next(), Some::<&str>("吃葡萄"));
	assert_eq!(clone.next(), Some::<&str>("吐葡萄"));
	assert_eq!(clone.next(), Some::<&str>(""));
	assert_eq!(clone.next(), Some::<&str>("吃葡萄倒吐葡萄"));
	assert_eq!(clone.next(), None::<&str>);
    }
