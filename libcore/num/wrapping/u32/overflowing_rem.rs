...
mod tests {
	...
	overflowing_rem_test!( u32, 0xffffffff, 0x00000000, (0xffffffff, always_false) ); // panicked at 'attempted to remide by zero'
    }
	...
	overflowing_rem_test!( u32, 0xffffffff, 0x00000001, (0x00000000, always_false) );
	overflowing_rem_test!( u32, 0xffffffff, 0x00000002, (0x00000001, always_false) );
	overflowing_rem_test!( u32, 0xffffffff, 0x00000003, (0x00000000, always_false) );
	overflowing_rem_test!( u32, 0xffffffff, 0x00000004, (0x00000003, always_false) );
    }
}
