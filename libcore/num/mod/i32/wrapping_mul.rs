...
mod tests {
	...
	($value:expr, $rhs:expr, $result:expr) => ({
	    let x: i32 = $value;
	    let rhs: i32  = $rhs;
	    let result: i32 = x.wrapping_mul(rhs);
	...
	wrapping_mul_test!( 0x7fffffff, 0x00000001, 0x7fffffff );
	wrapping_mul_test!( 0x7fffffff, 0xffffffff, 0x80000001 );
	wrapping_mul_test!( 0x80000000, 0xffffffff, 0x80000000 );
    }
}
