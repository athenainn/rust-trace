...
mod tests {
	...
	assert_eq!(chars.next(), Some::<char>('我'));
	assert_eq!(chars.next(), Some::<char>('能'));
	assert_eq!(chars.next(), Some::<char>('吞'));
	assert_eq!(chars.next(), Some::<char>('下'));
	assert_eq!(chars.next(), Some::<char>('玻'));
	assert_eq!(chars.next(), Some::<char>('璃'));
	assert_eq!(chars.next(), Some::<char>('而'));
	assert_eq!(chars.next(), Some::<char>('不'));
	assert_eq!(chars.next(), Some::<char>('傷'));
	assert_eq!(chars.next(), Some::<char>('身'));
	assert_eq!(chars.next(), Some::<char>('體'));
	assert_eq!(chars.next(), Some::<char>('。'));
	assert_eq!(chars.next(), None::<char>);
    }
}
