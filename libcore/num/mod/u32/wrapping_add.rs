...
mod tests {
	...
	($value:expr, $rhs:expr, $result:expr) => ({
	    let x: u32 = $value;
	    let rhs: u32  = $rhs;
	    let result: u32 = x.wrapping_add(rhs);
	...
	wrapping_add_test!( 0xffff0000, 0x0000ffff, 0xffffffff );
	wrapping_add_test!( 0xffffffff, 0x00000001, 0x00000000 );
	wrapping_add_test!( 0xffffffff, 0xffffffff, 0xfffffffe );
    }
}
