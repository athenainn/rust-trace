...
mod tests {
	...
	($value:expr, $rhs:expr, $result:expr) => ({
	    let x: u16 = $value;
	    let rhs: u32  = $rhs;
	    let result: u16 = x.wrapping_shr(rhs);
	...
	wrapping_shr_test!( 0x8000, 0, 0x8000 );
	wrapping_shr_test!( 0x8000, 1, 0x4000 );
	wrapping_shr_test!( 0x8000, 2, 0x2000 );
	wrapping_shr_test!( 0x8000, 3, 0x1000 );
	wrapping_shr_test!( 0x8000, 4, 0x0800 );
	wrapping_shr_test!( 0x8000, 5, 0x0400 );
	wrapping_shr_test!( 0x8000, 6, 0x0200 );
	wrapping_shr_test!( 0x8000, 7, 0x0100 );
	wrapping_shr_test!( 0x8000, 8, 0x0080 );
	wrapping_shr_test!( 0x8000, 9, 0x0040 );
	wrapping_shr_test!( 0x8000, 10, 0x0020 );
	wrapping_shr_test!( 0x8000, 11, 0x0010 );
	wrapping_shr_test!( 0x8000, 12, 0x0008 );
	wrapping_shr_test!( 0x8000, 13, 0x0004 );
	wrapping_shr_test!( 0x8000, 14, 0x0002 );
	wrapping_shr_test!( 0x8000, 15, 0x0001 );
	wrapping_shr_test!( 0x8000, 16, 0x8000 );
    }
}
