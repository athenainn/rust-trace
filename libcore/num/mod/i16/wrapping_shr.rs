...
mod tests {
	...
	($value:expr, $rhs:expr, $result:expr) => ({
	    let x: i16 = $value;
	    let rhs: u32  = $rhs;
	    let result: i16 = x.wrapping_shr(rhs);
	...
	wrapping_shr_test!( 0x8000, 1, 0xc000 );
	wrapping_shr_test!( 0x8000, 2, 0xe000 );
	wrapping_shr_test!( 0x8000, 3, 0xf000 );
	wrapping_shr_test!( 0x8000, 4, 0xf800 );
	wrapping_shr_test!( 0x8000, 5, 0xfc00 );
	wrapping_shr_test!( 0x8000, 6, 0xfe00 );
	wrapping_shr_test!( 0x8000, 7, 0xff00 );
	wrapping_shr_test!( 0x8000, 8, 0xff80 );
	wrapping_shr_test!( 0x8000, 9, 0xffc0 );
	wrapping_shr_test!( 0x8000, 10, 0xffe0 );
	wrapping_shr_test!( 0x8000, 11, 0xfff0 );
	wrapping_shr_test!( 0x8000, 12, 0xfff8 );
	wrapping_shr_test!( 0x8000, 13, 0xfffc );
	wrapping_shr_test!( 0x8000, 14, 0xfffe );
	wrapping_shr_test!( 0x8000, 15, 0xffff );
