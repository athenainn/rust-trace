...
mod tests {
    ...
    #[test]
    fn from_be_test1() {
	from_be_test!( 0x00000001 );
	from_be_test!( 0x00000002 );
	from_be_test!( 0x00000004 );
	from_be_test!( 0x00000008 );
	from_be_test!( 0x00000010 );
	from_be_test!( 0x00000020 );
	from_be_test!( 0x00000040 );
	from_be_test!( 0x00000080 );
	from_be_test!( 0x00000100 );
	from_be_test!( 0x00000200 );
	from_be_test!( 0x00000400 );
	from_be_test!( 0x00000800 );
	from_be_test!( 0x00001000 );
	from_be_test!( 0x00002000 );
	from_be_test!( 0x00004000 );
	from_be_test!( 0x00008000 );
	from_be_test!( 0x00010000 );
	from_be_test!( 0x00020000 );
	from_be_test!( 0x00040000 );
	from_be_test!( 0x00080000 );
	from_be_test!( 0x00100000 );
	from_be_test!( 0x00200000 );
	from_be_test!( 0x00400000 );
	from_be_test!( 0x00800000 );
	from_be_test!( 0x01000000 );
	from_be_test!( 0x02000000 );
	from_be_test!( 0x04000000 );
	from_be_test!( 0x08000000 );
	from_be_test!( 0x10000000 );
	from_be_test!( 0x20000000 );
	from_be_test!( 0x40000000 );
	from_be_test!( 0x80000000 );
    }
}
