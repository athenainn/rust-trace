...
#[cfg(test)]
mod tests {
    use core::intrinsics::atomic_nand_acqrel;
    ...
    macro_rules! atomic_nand_acqrel_test {
	($init:expr, $value:expr, $result:expr) => ({
		...
		let src: T = $value;
		let old: T = unsafe { atomic_nand_acqrel::<T>(dst, src) };
    ...
    #[test]
    fn atomic_nand_acqrel_test1() {
	atomic_nand_acqrel_test!( 0xff00, 0x0a0a, !0x0a00 );
    }
}
