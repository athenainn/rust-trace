...
mod tests {
	...
	overflowing_sub_test!( u64, 0xffffffff00000000, 0x00000000ffffffff, (0xfffffffe00000001, false) );
	overflowing_sub_test!( u64, 0x0000000000000000, 0x0000000000000001, (0xffffffffffffffff, true) );
    }
}
