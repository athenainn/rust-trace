...
mod tests {
	...
	let n: usize = 0;
	let pred: P = P;
	let mut rsplitn: RSplitN<T, P> = slice.rsplitn::<P>(n, pred);

	assert_eq!(rsplitn.next(), None::<&[T]>);
    }
	...
	assert_eq!(rsplitn.next(), Some::<&[T]>(&[11, 12, 12, 13, 14, 15, 16]));
	assert_eq!(rsplitn.next(), None::<&[T]>);
    }
	...
	assert_eq!(rsplitn.next(), Some::<&[T]>(&[16]));
	assert_eq!(rsplitn.next(), Some::<&[T]>(&[11, 12, 12, 13, 14]));
	assert_eq!(rsplitn.next(), None::<&[T]>);
    }
	...
	assert_eq!(rsplitn.next(), Some::<&[T]>(&[16]));
	assert_eq!(rsplitn.next(), Some::<&[T]>(&[13,14]));
	assert_eq!(rsplitn.next(), Some::<&[T]>(&[11, 12]));
	assert_eq!(rsplitn.next(), None::<&[T]>);
    }
	...
	assert_eq!(rsplitn.next(), Some::<&[T]>(&[16]));
	assert_eq!(rsplitn.next(), Some::<&[T]>(&[13,14]));
	assert_eq!(rsplitn.next(), Some::<&[T]>(&[]));
	assert_eq!(rsplitn.next(), Some::<&[T]>(&[11]));
	assert_eq!(rsplitn.next(), None::<&[T]>);
    }
