...
mod tests {
	...
	($value:expr, $v:expr, $overflow:expr) => ({
	    let x: i32 = $value;
	    let v: i32  = $v;
	    let result: Option<i32> = x.checked_div(v);
	...
	checked_div_test!( 0x7fff0000, 0x0000ffff, Some::<i32>(0x00007fff) );
	checked_div_test!( 0x7fffffff, 0x00000000, None::<i32> );

	checked_div_test!( 0x7fffffff, 0xffffffff, Some::<i32>(0x80000001) );
	checked_div_test!( 0x80000000, 0xffffffff, None::<i32> );
    }
}
