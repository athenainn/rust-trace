...
mod tests {
	...
	if cfg!(target_pointer_width = "64") {
	    overflowing_div_test!( isize, 0x7fffffffffffffff, 0x0000000000000001, (0x7fffffffffffffff, false) );
	    overflowing_div_test!( isize, 0x8000000000000000, 0xffffffffffffffff, (0x8000000000000000, true) );
	} else {
	    overflowing_div_test!( isize, 0x7fffffff, 0x00000001, (0x7fffffff, false) );
	    overflowing_div_test!( isize, 0x80000000, 0xffffffff, (0x80000000, true) );
	}
    }
	...
	if cfg!(target_pointer_width = "64") {
	    overflowing_div_test!( isize, 0x7fffffffffffffff, 0x0000000000000000, (0x7fffffffffffffff, false) ); // panicked at 'attempted to divide by zero'
	} else {
	    overflowing_div_test!( isize, 0x7fffffff, 0x00000000, (0x7fffffff, false) ); // panicked at 'attempted to divide by zero'
	}
    }
}
