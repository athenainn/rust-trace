...
mod tests {
	...
	($value:expr, $rhs:expr, $result:expr) => ({
	    let x: i64 = $value;
	    let rhs: i64  = $rhs;
	    let result: i64 = x.wrapping_add(rhs);
	...
	wrapping_add_test!( 0x7fffffff00000000, 0x00000000ffffffff, 0x7fffffffffffffff );
	wrapping_add_test!( 0x7fffffffffffffff, 0x0000000000000001, 0x8000000000000000 );
	wrapping_add_test!( 0x8000000000000000, 0xffffffffffffffff, 0x7fffffffffffffff );
    }
}
