...
mod tests {
	...
	overflowing_mul_test!( i32, 0x7fffffff, 0x00000001, (0x7fffffff, false) );
	overflowing_mul_test!( i32, 0x7fffffff, 0x00000002, (0xfffffffe, true) );
	overflowing_mul_test!( i32, 0x80000000, 0xffffffff, (0x80000000, true) );
    }
}
