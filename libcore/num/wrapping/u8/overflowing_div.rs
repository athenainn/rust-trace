...
mod tests {
	...
	overflowing_div_test!( u8, 0xff, 0x01, (0xff, always_false) );
	overflowing_div_test!( u8, 0xff, 0x02, (0x7f, always_false) );
    }
	...
	overflowing_div_test!( u8, 0xff, 0x00, (0xff, always_false) ); // panicked at 'attempted to divide by zero'
    }
}
