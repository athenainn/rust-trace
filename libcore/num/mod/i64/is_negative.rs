...
mod tests {
    ...
    macro_rules! is_negative_test {
	($value:expr, $result:expr) => ({
	    let x: i64 = $value;
	    let result: bool = x.is_negative();
    ...
    fn is_negative_test1() {
	is_negative_test!( 0x7fffffffffffffff, false );
	is_negative_test!( 0x0000000000000001, false );
	is_negative_test!( 0x0000000000000000, false );
	is_negative_test!( 0x8000000000000000, true );
	is_negative_test!( 0xffffffffffffffff, true );
    }
}
