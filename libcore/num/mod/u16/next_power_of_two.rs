...
mod tests {
	...
	($value:expr, $result:expr) => ({
	    let x: u16 = $value;
	    let result: u16 = x.next_power_of_two();
	...
	next_power_of_two_test!( 0x0000, 0x0001 );
	next_power_of_two_test!( 0x0001, 0x0001 );
	next_power_of_two_test!( 0x0003, 0x0004 );
	next_power_of_two_test!( 0x0005, 0x0008 );
	next_power_of_two_test!( 0x0009, 0x0010 );
	next_power_of_two_test!( 0x0011, 0x0020 );
	next_power_of_two_test!( 0x0021, 0x0040 );
	next_power_of_two_test!( 0x0041, 0x0080 );
	next_power_of_two_test!( 0x0081, 0x0100 );
	next_power_of_two_test!( 0x0101, 0x0200 );
	next_power_of_two_test!( 0x0201, 0x0400 );
	next_power_of_two_test!( 0x0401, 0x0800 );
	next_power_of_two_test!( 0x0801, 0x1000 );
	next_power_of_two_test!( 0x1001, 0x2000 );
	next_power_of_two_test!( 0x2001, 0x4000 );
	next_power_of_two_test!( 0x4001, 0x8000 );
	next_power_of_two_test!( 0x8001, 0x0001 );
    }
}
