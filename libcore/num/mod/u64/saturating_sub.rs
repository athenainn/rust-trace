...
mod tests {
	...
	($value:expr, $other:expr, $result:expr) => ({
	    let x: u64 = $value;
	    let other: u64  = $other;
	    let result: u64 = x.saturating_sub(other);
	...
	saturating_sub_test!( 0xffffffff00000000, 0x00000000ffffffff, 0xfffffffe00000001 );
	saturating_sub_test!( 0x0000000000000000, 0x0000000000000001, 0x0000000000000000 );
    }
}
