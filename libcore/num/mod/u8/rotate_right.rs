...
mod tests {
	...
	($value:expr, $n:expr, $result:expr) => ({
	    let value: u8 = $value;
	    let n: u32 = $n;
	    let result: u8 = value.rotate_right(n);
	...
	rotate_right_test!( 0x80, 0, 0x80 );
	rotate_right_test!( 0x80, 1, 0x40 );
	rotate_right_test!( 0x80, 2, 0x20 );
	rotate_right_test!( 0x80, 3, 0x10 );
	rotate_right_test!( 0x80, 4, 0x08 );
	rotate_right_test!( 0x80, 5, 0x04 );
	rotate_right_test!( 0x80, 6, 0x02 );
	rotate_right_test!( 0x80, 7, 0x01 );
	rotate_right_test!( 0x80, 8, 0x80 );
    }
}
