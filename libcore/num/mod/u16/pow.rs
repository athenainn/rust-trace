...
mod tests {
    ...
    #[test]
    fn pow_test1() {
	pow_test!( 0x0002, 0, 0x0001 );
	pow_test!( 0x0002, 1, 0x0002 );
	pow_test!( 0x0002, 2, 0x0004 );
	pow_test!( 0x0002, 3, 0x0008 );
	pow_test!( 0x0002, 4, 0x0010 );
	pow_test!( 0x0002, 5, 0x0020 );
	pow_test!( 0x0002, 6, 0x0040 );
	pow_test!( 0x0002, 7, 0x0080 );
	pow_test!( 0x0002, 8, 0x0100 );
	pow_test!( 0x0002, 9, 0x0200 );
	pow_test!( 0x0002, 10, 0x0400 );
	pow_test!( 0x0002, 11, 0x0800 );
	pow_test!( 0x0002, 12, 0x1000 );
	pow_test!( 0x0002, 13, 0x2000 );
	pow_test!( 0x0002, 14, 0x4000 );
	pow_test!( 0x0002, 15, 0x8000 );
    }

    #[test]
    #[should_panic]
    fn pow_test2() {
	pow_test!( 0x0002, 16, 0x0000 ); // panicked at 'arithmetic operation overflowed'
    }
}
