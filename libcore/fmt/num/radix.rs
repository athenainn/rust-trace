...
mod tests {
	...
	((), $value:expr, $base:expr, $s:expr) => ();
	(($T:ty, $($other:ty,)*), $value:expr, $base:expr, $s:expr) => (
	    {
		let x: $T = $value;
		let base: u8 = $base;
	    ...
	    radix_fmt_test_impl!(($($other,)*), $value, $base, $s);
	)
    }
	...
	radix_fmt_test_impl! {
	    (u8, u16, u32, u64, usize, i8, i16, i32, i64, isize,),
	    68, 1, ""
	}; // panicked at 'the base must be in the range of 2..36: 1'
    }
	...
	radix_fmt_test_impl! {
	    (u8, u16, u32, u64, usize, i8, i16, i32, i64, isize,),
	    68, 37, ""
	}; // panicked at 'the base must be in the range of 2..36: 37'
    }
