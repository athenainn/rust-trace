...
mod tests {
	...
	let pat: P = "葡萄皮";
	let mut rsplit: RSplit<P> = x.rsplit::<P>(pat);
	let mut clone: RSplit<P> = rsplit.clone();

	assert_eq!(rsplit.next(), Some::<&str>(""));
	assert_eq!(rsplit.next(), Some::<&str>("不吃葡萄倒吐"));
	assert_eq!(rsplit.next(), Some::<&str>("吃葡萄不吐"));
	assert_eq!(rsplit.next(), None::<&str>);
	...
	assert_eq!(rsplit.next(), Some::<&str>(""));
	assert_eq!(rsplit.next(), Some::<&str>("不吃葡萄倒吐葡萄"));
	assert_eq!(rsplit.next(), Some::<&str>("吃葡萄不吐葡萄"));
	assert_eq!(rsplit.next(), None::<&str>);
	...
	assert_eq!(rsplit.next(), Some::<&str>(""));
	assert_eq!(rsplit.next(), Some::<&str>("葡萄倒吐葡萄"));
	assert_eq!(rsplit.next(), Some::<&str>("不"));
	assert_eq!(rsplit.next(), Some::<&str>("葡萄不吐葡萄"));
	assert_eq!(rsplit.next(), Some::<&str>(""));
	assert_eq!(rsplit.next(), None::<&str>);
