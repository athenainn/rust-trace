...
mod tests {
	...
	overflowing_div_test!( u32, 0xffffffff, 0x00000001, (0xffffffff, always_false) );
	overflowing_div_test!( u32, 0xffffffff, 0x00000002, (0x7fffffff, always_false) );
    }
	...
	overflowing_div_test!( u32, 0xffffffff, 0x00000000, (0xffffffff, always_false) ); // panicked at 'attempted to divide by zero'
    }
}
