...
mod tests {
	...
	overflowing_rem_test!( u8, 0xff, 0x00, (0xff, always_false) ); // panicked at 'attempted to remide by zero'
    }
	...
	overflowing_rem_test!( u8, 0xff, 0x01, (0x00, always_false) );
	overflowing_rem_test!( u8, 0xff, 0x02, (0x01, always_false) );
	overflowing_rem_test!( u8, 0xff, 0x03, (0x00, always_false) );
	overflowing_rem_test!( u8, 0xff, 0x04, (0x03, always_false) );
    }
}
