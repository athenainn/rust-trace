...
mod tests {
	...
	overflowing_sub_test!( i16, 0x7f00, 0x00ff, (0x7e01, false) );
	overflowing_sub_test!( i16, 0x7fff, 0xffff, (0x8000, true) );
	overflowing_sub_test!( i16, 0x8000, 0x0001, (0x7fff, true) );
    }
}
