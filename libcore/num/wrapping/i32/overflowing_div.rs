...
mod tests {
	...
	overflowing_div_test!( i32, 0x7fffffff, 0x00000001, (0x7fffffff, false) );
	overflowing_div_test!( i32, 0x80000000, 0xffffffff, (0x80000000, true) );
    }

    #[test]
    #[should_panic]
    fn overflowing_div_test2() {
	overflowing_div_test!( i32, 0x7fffffff, 0x00000000, (0x7fffffff, false) ); // panicked at 'attempted to divide by zero'
    }
}
