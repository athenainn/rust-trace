...
mod tests {
	...
	($value:expr, $rhs:expr, $result:expr) => ({
	    let x: i32 = $value;
	    let rhs: i32  = $rhs;
	    let result: i32 = x.wrapping_sub(rhs);
	...
	wrapping_sub_test!( 0x7fff0000, 0x0000ffff, 0x7ffe0001 );
	wrapping_sub_test!( 0x80000000, 0x00000001, 0x7fffffff );
	wrapping_sub_test!( 0x7fffffff, 0xffffffff, 0x80000000 );
    }
}
