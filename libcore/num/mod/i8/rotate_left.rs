...
mod tests {
	...
	($value:expr, $n:expr, $result:expr) => ({
	    let value: i8 = $value;
	    let n: u32 = $n;
	    let result: i8 = value.rotate_left(n);
	...
	rotate_left_test!( 0x01, 0, 0x01 );
	rotate_left_test!( 0x01, 1, 0x02 );
	rotate_left_test!( 0x01, 2, 0x04 );
	rotate_left_test!( 0x01, 3, 0x08 );
	rotate_left_test!( 0x01, 4, 0x10 );
	rotate_left_test!( 0x01, 5, 0x20 );
	rotate_left_test!( 0x01, 6, 0x40 );
	rotate_left_test!( 0x01, 7, 0x80 );
	rotate_left_test!( 0x01, 8, 0x01 );
    }
}
