...
mod tests {
	...
	overflowing_rem_test!( i8, 0x7f, 0x00, (0x7f, false) ); // panicked at 'attempted remainder with a divisor of zero'
    }

    #[test]
    #[allow(overflowing_literals)]
    fn overflowing_rem_test2() {
	overflowing_rem_test!( i8, 0x7f, 0x01, (0x00, false) );
	overflowing_rem_test!( i8, 0x7f, 0x02, (0x01, false) );
	overflowing_rem_test!( i8, 0x7f, 0x03, (0x01, false) );
	overflowing_rem_test!( i8, 0x7f, 0x04, (0x03, false) );
	overflowing_rem_test!( i8, 0x80, 0xff, (0x00, true) );
    }
}
