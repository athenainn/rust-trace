...
mod tests {
	...
	($value:expr, $rhs:expr, $result:expr) => ({
	    let x: i8 = $value;
	    let rhs: i8  = $rhs;
	    let result: i8 = x.wrapping_rem(rhs);
	...
	let x: i8 = 68;
	let rhs: i8  = 0;
	let _: i8 = x.wrapping_rem(rhs); // panicked at 'attempted remainder with a divisor of zero'
    }

    #[test]
    #[allow(overflowing_literals)]
    fn wrapping_rem_test2() {
	wrapping_rem_test!( 0x7f, 0x01, 0x00 );
	wrapping_rem_test!( 0x7f, 0x02, 0x01 );
	wrapping_rem_test!( 0x7f, 0x03, 0x01 );
	wrapping_rem_test!( 0x80, 0xff, 0x00 );
    }
}
