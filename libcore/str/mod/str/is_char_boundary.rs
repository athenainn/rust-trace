...
mod tests {
    ...
    #[test]
    fn is_char_boundary_test1() {
	let x: &str = "勤能補拙";

	assert_eq!(x.len(), 12);
	assert_eq!(x.is_char_boundary(0), true);
	assert_eq!(x.is_char_boundary(1), false);
	assert_eq!(x.is_char_boundary(2), false);
	assert_eq!(x.is_char_boundary(3), true);
	assert_eq!(x.is_char_boundary(4), false);
	assert_eq!(x.is_char_boundary(5), false);
	assert_eq!(x.is_char_boundary(6), true);
	assert_eq!(x.is_char_boundary(7), false);
	assert_eq!(x.is_char_boundary(8), false);
	assert_eq!(x.is_char_boundary(9), true);
	assert_eq!(x.is_char_boundary(10), false);
	assert_eq!(x.is_char_boundary(11), false);

	assert_eq!(x.is_char_boundary(12), true); // index == len() always true

	for index in 13..68 {
	    assert_eq!(x.is_char_boundary(index), false);
	}
    }
}
