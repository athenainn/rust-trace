...
mod tests {
	...
	overflowing_div_test!( i16, 0x7fff, 0x0001, (0x7fff, false) );
	overflowing_div_test!( i16, 0x8000, 0xffff, (0x8000, true) );
    }

    #[test]
    #[should_panic]
    fn overflowing_div_test2() {
	overflowing_div_test!( i16, 0x7fff, 0x0000, (0x7fff, false) ); // panicked at 'attempted to divide by zero'
    }
}
