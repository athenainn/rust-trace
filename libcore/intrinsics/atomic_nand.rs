...
#[cfg(test)]
mod tests {
    use core::intrinsics::atomic_nand;
	...
	($init:expr, $value:expr, $result:expr) => ({
		...
		let src: T = $value;
		let old: T = unsafe { atomic_nand::<T>(dst, src) };
    ...
    #[test]
    fn atomic_nand_test1() {
	atomic_nand_test!( 0xff00, 0x0a0a, !0x0a00 );
    }
}
