...
mod tests {
	...
	let pat: P = "葡萄皮";
	let mut split: Split<P> = x.split::<P>(pat);
	let mut clone: Split<P> = split.clone();

	assert_eq!(split.next(), Some::<&str>("吃葡萄不吐"));
	assert_eq!(split.next(), Some::<&str>("不吃葡萄倒吐"));
	assert_eq!(split.next(), Some::<&str>(""));
	assert_eq!(split.next(), None::<&str>);
	...
	assert_eq!(split.next(), Some::<&str>("吃葡萄不吐葡萄"));
	assert_eq!(split.next(), Some::<&str>("不吃葡萄倒吐葡萄"));
	assert_eq!(split.next(), Some::<&str>(""));
	assert_eq!(split.next(), None::<&str>);
	...
	assert_eq!(split.next(), Some::<&str>("吃葡萄"));
	assert_eq!(split.next(), Some::<&str>("吐葡萄"));
	assert_eq!(split.next(), Some::<&str>(""));
	assert_eq!(split.next(), Some::<&str>("吃葡萄倒吐葡萄"));
	assert_eq!(split.next(), Some::<&str>(""));
	assert_eq!(split.next(), None::<&str>);
