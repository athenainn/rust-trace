...
mod tests {
	...
	let pat: P = "葡萄皮";
	let mut matches: Matches<P> = x.matches::<P>(pat);
	let mut clone: Matches<P> = matches.clone();

	assert_eq!(matches.next(), Some::<&str>("葡萄皮"));
	assert_eq!(matches.next(), Some::<&str>("葡萄皮"));
	assert_eq!(matches.next(), None::<&str>);
	...
	assert_eq!(matches.next(), Some::<&str>("皮"));
	assert_eq!(matches.next(), Some::<&str>("皮"));
	assert_eq!(matches.next(), None::<&str>);
	...
	assert_eq!(matches.next(), Some::<&str>("不"));
	assert_eq!(matches.next(), Some::<&str>("皮"));
	assert_eq!(matches.next(), Some::<&str>("不"));
	assert_eq!(matches.next(), Some::<&str>("皮"));
	assert_eq!(matches.next(), None::<&str>);
