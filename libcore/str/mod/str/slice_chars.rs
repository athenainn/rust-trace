...
mod tests {
    ...
    #[test]
    fn slice_chars_test1() {
	let x: &str = "吃葡萄不吐葡萄皮不吃葡萄倒吐葡萄皮";
	let begin: usize = 5;
	let end: usize = 8;
	let result: &str = x.slice_chars(begin, end);

	assert_eq!(result, "葡萄皮");
    }

    #[test]
    #[should_panic]
    fn slice_chars_test2() {
	let x: &str = "吃葡萄不吐葡萄皮不吃葡萄倒吐葡萄皮";
	let begin: usize = 68;
	let end: usize = 500;
	let _: &str = x.slice_chars(begin, end); // panicked at 'slice_chars: `begin` is beyond end of string'
    }

    #[test]
    #[should_panic]
    fn slice_chars_test3() {
	let x: &str = "吃葡萄不吐葡萄皮不吃葡萄倒吐葡萄皮";
	let begin: usize = 0;
	let end: usize = 500;
	let _: &str = x.slice_chars(begin, end); // panicked at 'slice_chars: `end` is beyond end of string'
    }
}
