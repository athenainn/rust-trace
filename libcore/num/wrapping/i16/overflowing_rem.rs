...
mod tests {
	...
	overflowing_rem_test!( i16, 0x7fff, 0x0000, (0x7fff, false) ); // panicked at 'attempted remainder with a divisor of zero'
    }

    #[test]
    #[allow(overflowing_literals)]
    fn overflowing_rem_test2() {
	overflowing_rem_test!( i16, 0x7fff, 0x0001, (0x0000, false) );
	overflowing_rem_test!( i16, 0x7fff, 0x0002, (0x0001, false) );
	overflowing_rem_test!( i16, 0x7fff, 0x0003, (0x0001, false) );
	overflowing_rem_test!( i16, 0x7fff, 0x0004, (0x0003, false) );
	overflowing_rem_test!( i16, 0x8000, 0xffff, (0x0000, true) );
    }
}
