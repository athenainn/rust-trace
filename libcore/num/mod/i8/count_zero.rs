...
mod tests {
	...
	count_zeros_test!( 0x00, 8 );
	count_zeros_test!( 0x01, 7 );
	count_zeros_test!( 0x03, 6 );
	count_zeros_test!( 0x07, 5 );
	count_zeros_test!( 0x0f, 4 );
	count_zeros_test!( 0x1f, 3 );
	count_zeros_test!( 0x3f, 2 );
	count_zeros_test!( 0x7f, 1 );
	count_zeros_test!( 0xff, 0 );
    }
}
