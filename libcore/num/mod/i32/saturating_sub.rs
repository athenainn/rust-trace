...
mod tests {
	...
	($value:expr, $other:expr, $result:expr) => ({
	    let x: i32 = $value;
	    let other: i32  = $other;
	    let result: i32 = x.saturating_sub(other);
	...
	saturating_sub_test!( 0x7fff0000, 0x0000ffff, 0x7ffe0001 );
	saturating_sub_test!( 0x7fffffff, 0xffffffff, 0x7fffffff );
	saturating_sub_test!( 0x80000000, 0x00000001, 0x80000000 );
    }
}
