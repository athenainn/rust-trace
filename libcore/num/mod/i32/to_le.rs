...
mod tests {
    ...
    // unsafe fn bswap8(x: i32) -> i32 { x }

    macro_rules! to_le_test {
	($value:expr) => ({
	    let x: i32 = $value;
	    let result: i32 = i32::to_le(x);
    ...
    fn to_le_test1() {
	to_le_test!( 0x00000001 );
	to_le_test!( 0x00000002 );
	to_le_test!( 0x00000004 );
	to_le_test!( 0x00000008 );
	to_le_test!( 0x00000010 );
	to_le_test!( 0x00000020 );
	to_le_test!( 0x00000040 );
	to_le_test!( 0x00000080 );
	to_le_test!( 0x00000100 );
	to_le_test!( 0x00000200 );
	to_le_test!( 0x00000400 );
	to_le_test!( 0x00000800 );
	to_le_test!( 0x00001000 );
	to_le_test!( 0x00002000 );
	to_le_test!( 0x00004000 );
	to_le_test!( 0x00008000 );
	to_le_test!( 0x00010000 );
	to_le_test!( 0x00020000 );
	to_le_test!( 0x00040000 );
	to_le_test!( 0x00080000 );
	to_le_test!( 0x00100000 );
	to_le_test!( 0x00200000 );
	to_le_test!( 0x00400000 );
	to_le_test!( 0x00800000 );
	to_le_test!( 0x01000000 );
	to_le_test!( 0x02000000 );
	to_le_test!( 0x04000000 );
	to_le_test!( 0x08000000 );
	to_le_test!( 0x10000000 );
	to_le_test!( 0x20000000 );
	to_le_test!( 0x40000000 );
	to_le_test!( 0x80000000 );
    }
}
