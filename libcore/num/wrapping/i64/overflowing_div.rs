...
mod tests {
	...
	overflowing_div_test!( i64, 0x7fffffffffffffff, 0x0000000000000001, (0x7fffffffffffffff, false) );
	overflowing_div_test!( i64, 0x8000000000000000, 0xffffffffffffffff, (0x8000000000000000, true) );
    }

    #[test]
    #[should_panic]
    fn overflowing_div_test2() {
	overflowing_div_test!( i64, 0x7fffffffffffffff, 0x0000000000000000, (0x7fffffffffffffff, false) ); // panicked at 'attempted to divide by zero'
    }
}
