...
mod tests {
    ...
    macro_rules! checked_div_test {
	($value:expr, $v:expr, $overflow:expr) => ({
	    let x: i64 = $value;
	    let v: i64  = $v;
	    let result: Option<i64> = x.checked_div(v);
    ...
    fn checked_div_test1() {
	checked_div_test!( 0x7fffffff00000000, 0x00000000ffffffff, Some::<i64>(0x000000007fffffff) );
	checked_div_test!( 0x7fffffffffffffff, 0x0000000000000000, None::<i64> );

	checked_div_test!( 0x7fffffffffffffff, 0xffffffffffffffff, Some::<i64>(0x8000000000000001) );
	checked_div_test!( 0x8000000000000000, 0xffffffffffffffff, None::<i64> );
    }
}
