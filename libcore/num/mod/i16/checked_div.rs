...
mod tests {
	...
	($value:expr, $v:expr, $overflow:expr) => ({
	    let x: i16 = $value;
	    let v: i16  = $v;
	    let result: Option<i16> = x.checked_div(v);
	...
	checked_div_test!( 0x7f00, 0x00ff, Some::<i16>(0x07f) );
	checked_div_test!( 0x7fff, 0x0000, None::<i16> );

	checked_div_test!( 0x7fff, 0xffff, Some::<i16>(0x8001) );
	checked_div_test!( 0x8000, 0xffff, None::<i16> );
    }
}
