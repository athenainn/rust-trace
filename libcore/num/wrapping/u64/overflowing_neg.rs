...
mod tests {
	...
	overflowing_neg_test!( u64, 0x0000000000000000, (0x0000000000000000, always_true) );
	overflowing_neg_test!( u64, 0x0000000000000001, (0xffffffffffffffff, always_true) );
	overflowing_neg_test!( u64, 0x0000000000000002, (0xfffffffffffffffe, always_true) );
	overflowing_neg_test!( u64, 0x7fffffffffffffff, (0x8000000000000001, always_true) );
	overflowing_neg_test!( u64, 0x8000000000000000, (0x8000000000000000, always_true) );
    }
}
