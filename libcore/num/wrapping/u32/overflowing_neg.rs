...
mod tests {
	...
	overflowing_neg_test!( u32, 0x00000000, (0x00000000, always_true) );
	overflowing_neg_test!( u32, 0x00000001, (0xffffffff, always_true) );
	overflowing_neg_test!( u32, 0x00000002, (0xfffffffe, always_true) );
	overflowing_neg_test!( u32, 0x7fffffff, (0x80000001, always_true) );
	overflowing_neg_test!( u32, 0x80000000, (0x80000000, always_true) );
    }
}
