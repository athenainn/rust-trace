...
mod tests {
	...
	let bits: usize = 32;
	let mul_pow2: &mut Big32x36 = big.mul_pow2(bits);

	let result: String = format!("{:?}", mul_pow2);
	...
	let mut big: Big32x36 = Big32x36::from_small(v);
	let bits: usize = 32 * 36;
	let _: &mut Big32x36 = big.mul_pow2(bits); // panicked at 'assertion failed: digits < 36'
    }
}
