...
mod tests {
    ...
    #[test]
    fn count_ones_test1() {
	count_ones_test!( 0x00, 0 );
	count_ones_test!( 0x01, 1 );
	count_ones_test!( 0x03, 2 );
	count_ones_test!( 0x07, 3 );
	count_ones_test!( 0x0f, 4 );
	count_ones_test!( 0x1f, 5 );
	count_ones_test!( 0x3f, 6 );
	count_ones_test!( 0x7f, 7 );
	count_ones_test!( 0xff, 8 );
    }
}
