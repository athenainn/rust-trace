...
mod tests {
    ...
    fn shl_test1() {
	shl_test!( i8, 0x01, 0, 0x01 );
	shl_test!( i8, 0x01, 1, 0x02 );
	shl_test!( i8, 0x01, 2, 0x04 );
	shl_test!( i8, 0x01, 3, 0x08 );
	shl_test!( i8, 0x01, 4, 0x10 );
	shl_test!( i8, 0x01, 5, 0x20 );
	shl_test!( i8, 0x01, 6, 0x40 );
	shl_test!( i8, 0x01, 7, 0x80 );
    }

    #[test]
    #[should_panic]
    fn shl_test2() {
	shl_test!( i8, 0x01, 8, 0x00 ); // panicked at 'shift operation overflowed'
    }
}
