...
mod tests {
	...
	($value:expr, $rhs:expr, $result:expr) => ({
	    let x: i8 = $value;
	    let rhs: i8  = $rhs;
	    let result: i8 = x.wrapping_div(rhs);
	...
	let x: i8 = 68;
	let rhs: i8  = 0;
	let _: i8 = x.wrapping_div(rhs); // panicked at 'attempted to divide by zero'
    }

    #[test]
    #[allow(overflowing_literals)]
    fn wrapping_div_test2() {
	wrapping_div_test!( 0x7f, 0x01, 0x7f );
	wrapping_div_test!( 0x7f, 0xff, 0x81 );
	wrapping_div_test!( 0x80, 0xff, 0x80 );
    }
}
