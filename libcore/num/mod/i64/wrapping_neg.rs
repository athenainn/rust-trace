...
mod tests {
    ...
    macro_rules! wrapping_neg_test {
	($value:expr, $result:expr) => ({
	    let x: i64 = $value;
	    let result: i64 = x.wrapping_neg();
    ...
    fn wrapping_neg_test1() {
	wrapping_neg_test!( 0x0000000000000000, 0x0000000000000000 );
	wrapping_neg_test!( 0x7fffffffffffffff, 0x8000000000000001 );
	wrapping_neg_test!( 0x8000000000000000, 0x8000000000000000 );
    }
}
