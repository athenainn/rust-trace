...
#[cfg(test)]
mod tests {
    use core::intrinsics::atomic_xchg_acqrel;
    ...
    macro_rules! atomic_xchg_acqrel_test {
	($init:expr, $value:expr) => ({
		...
		let src: T = $value;
		let result: T = unsafe { atomic_xchg_acqrel::<T>(dst, src) };
    ...
    #[test]
    fn atomic_xchg_acqrel_test1() {
	atomic_xchg_acqrel_test!(  68, 500 );
    }
}
