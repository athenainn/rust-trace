...
mod tests {
    ...
    macro_rules! checked_mul_test {
	($value:expr, $other:expr, $overflow:expr) => ({
	    let x: i64 = $value;
	    let other: i64  = $other;
	    let result: Option<i64> = x.checked_mul(other);

	    assert_eq!(result, $overflow);
	})
    }

    #[test]
    #[allow(overflowing_literals)]
    fn checked_mul_test1() {
	checked_mul_test!( 0x7fffffffffffffff, 0x0000000000000001, Some::<i64>(0x7fffffffffffffff) );
	checked_mul_test!( 0x7fffffffffffffff, 0x0000000000000002, None::<i64> );

	checked_mul_test!( 0x7fffffffffffffff, 0xffffffffffffffff, Some::<i64>(0x8000000000000001) );
	checked_mul_test!( 0x8000000000000000, 0xffffffffffffffff, None::<i64> );
    }
}
