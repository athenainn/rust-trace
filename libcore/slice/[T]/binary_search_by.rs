...
mod tests {
    ...
    #[test]
    fn binary_search_by_test1() {
	let slice: &[T] = &[11, 12, 12, 13, 14, 15, 16];
	let f: F = F;
	let binary_search_by: Result<usize, usize> = slice.binary_search_by::<F>(f);
    ...
    #[test]
    fn binary_search_by_test2() {
	let slice: &[T] = &[11, 12, 12, 13, 14];
	let f: F = F;
	let binary_search_by: Result<usize, usize> = slice.binary_search_by::<F>(f);
    ...
    #[test]
    fn binary_search_by_test3() {
	let slice: &[T] = &[11, 12, 12, 13, 14, 16];
	let f: F = F;
	let binary_search_by: Result<usize, usize> = slice.binary_search_by::<F>(f);
    ...
    #[test]
    fn binary_search_by_test4() {
	let slice: &[T] = &[13, 14, 16];
	let f: F = F;
	let binary_search_by: Result<usize, usize> = slice.binary_search_by::<F>(f);
