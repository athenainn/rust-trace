...
mod tests {
	...
	($value:expr, $other:expr, $overflow:expr) => ({
	    let x: i32 = $value;
	    let other: i32  = $other;
	    let result: Option<i32> = x.checked_sub(other);
	...
	checked_sub_test!( 0x7fff0000, 0x0000ffff, Some::<i32>(0x7ffe0001) );
	checked_sub_test!( 0x7fffffff, 0xffffffff, None::<i32> );
	checked_sub_test!( 0x80000000, 0x00000001, None::<i32> );
    }
}
