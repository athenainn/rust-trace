...
mod tests {
	...
	($value:expr, $v:expr, $overflow:expr) => ({
	    let x: i8 = $value;
	    let v: i8  = $v;
	    let result: Option<i8> = x.checked_div(v);
	...
	checked_div_test!( 0x70, 0x0f, Some::<i8>(0x07) );
	checked_div_test!( 0x7f, 0x00, None::<i8> );

	checked_div_test!( 0x7f, 0xff, Some::<i8>(0x81) );
	checked_div_test!( 0x80, 0xff, None::<i8> );
    }
}
