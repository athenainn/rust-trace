...
#[cfg(test)]
mod tests {
    use core::intrinsics::atomic_nand_relaxed;
    ...
    macro_rules! atomic_nand_relaxed_test {
	($init:expr, $value:expr, $result:expr) => ({
		...
		let src: T = $value;
		let old: T = unsafe { atomic_nand_relaxed::<T>(dst, src) };
    ...
    #[test]
    fn atomic_nand_relaxed_test1() {
	atomic_nand_relaxed_test!( 0xff00, 0x0a0a, !0x0a00 );
    }
}
