...
mod tests {
	...
	($value:expr, $result:expr) => ({
	    let x: u16 = $value;
	    let result: Option<u16> = x.checked_next_power_of_two();
	...
	checked_next_power_of_two_test!( 0x0000, Some::<u16>(0x0001) );
	checked_next_power_of_two_test!( 0x0001, Some::<u16>(0x0001) );
	checked_next_power_of_two_test!( 0x0003, Some::<u16>(0x0004) );
	checked_next_power_of_two_test!( 0x0005, Some::<u16>(0x0008) );
	checked_next_power_of_two_test!( 0x0009, Some::<u16>(0x0010) );
	checked_next_power_of_two_test!( 0x0011, Some::<u16>(0x0020) );
	checked_next_power_of_two_test!( 0x0021, Some::<u16>(0x0040) );
	checked_next_power_of_two_test!( 0x0041, Some::<u16>(0x0080) );
	checked_next_power_of_two_test!( 0x0081, Some::<u16>(0x0100) );
	checked_next_power_of_two_test!( 0x0101, Some::<u16>(0x0200) );
	checked_next_power_of_two_test!( 0x0201, Some::<u16>(0x0400) );
	checked_next_power_of_two_test!( 0x0401, Some::<u16>(0x0800) );
	checked_next_power_of_two_test!( 0x0801, Some::<u16>(0x1000) );
	checked_next_power_of_two_test!( 0x1001, Some::<u16>(0x2000) );
	checked_next_power_of_two_test!( 0x2001, Some::<u16>(0x4000) );
	checked_next_power_of_two_test!( 0x4001, Some::<u16>(0x8000) );
	checked_next_power_of_two_test!( 0x8001, None::<u16> );
    }
}
