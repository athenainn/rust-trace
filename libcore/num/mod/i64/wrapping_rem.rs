...
mod tests {
    ...
    macro_rules! wrapping_rem_test {
	($value:expr, $rhs:expr, $result:expr) => ({
	    let x: i64 = $value;
	    let rhs: i64  = $rhs;
	    let result: i64 = x.wrapping_rem(rhs);
    ...
    #[test]
    #[should_panic]
    fn wrapping_rem_test1() {
	let x: i64 = 68;
	let rhs: i64  = 0;
	let _: i64 = x.wrapping_rem(rhs); // panicked at 'attempted remainder with a divisor of zero'
    }

    #[test]
    #[allow(overflowing_literals)]
    fn wrapping_rem_test2() {
	wrapping_rem_test!( 0x7fffffffffffffff, 0x0000000000000001, 0x0000000000000000 );
	wrapping_rem_test!( 0x7fffffffffffffff, 0x0000000000000002, 0x0000000000000001 );
	wrapping_rem_test!( 0x7fffffffffffffff, 0x0000000000000003, 0x0000000000000001 );
	wrapping_rem_test!( 0x7fffffffffffffff, 0x0000000000000004, 0x0000000000000003 );
	wrapping_rem_test!( 0x8000000000000000, 0xffffffffffffffff, 0x0000000000000000 );
    }
}
