...
mod tests {
    ...
    macro_rules! signum_test {
	($value:expr, $result:expr) => ({
	    let x: i64 = $value;
	    let result: i64 = x.signum();
    ...
    fn signum_test1() {
	signum_test!( 0x7fffffffffffffff, 1 );
	signum_test!( 0x0000000000000001, 1 );
	signum_test!( 0x0000000000000000, 0 );
	signum_test!( 0x8000000000000000, -1 );
	signum_test!( 0xffffffffffffffff, -1 );
    }
}
