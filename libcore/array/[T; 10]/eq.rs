...
mod tests {
	...
	assert_eq!(array_a.eq(&array_b), true);
	...
	assert_eq!(array_a.eq(&*slice_b), true);
	assert_eq!(array_a == *slice_b, true);

	assert_eq!((*slice_b).eq(&array_a), true);
	assert_eq!((*slice_b) == array_a, true);
    }
