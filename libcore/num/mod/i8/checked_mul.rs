...
mod tests {
	...
	($value:expr, $other:expr, $overflow:expr) => ({
	    let x: i8 = $value;
	    let other: i8  = $other;
	    let result: Option<i8> = x.checked_mul(other);
	...
	checked_mul_test!( 0x7f, 0x01, Some::<i8>(0x7f) );
	checked_mul_test!( 0x7f, 0x02, None::<i8> );

	checked_mul_test!( 0x7f, 0xff, Some::<i8>(0x81) );
	checked_mul_test!( 0x80, 0xff, None::<i8> );
    }
}
