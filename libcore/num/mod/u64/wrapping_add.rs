...
mod tests {
    ...
    macro_rules! wrapping_add_test {
	($value:expr, $rhs:expr, $result:expr) => ({
	    let x: u64 = $value;
	    let rhs: u64  = $rhs;
	    let result: u64 = x.wrapping_add(rhs);
    ...
    #[test]
    fn wrapping_add_test1() {
	wrapping_add_test!( 0xffffffff00000000, 0x00000000ffffffff, 0xffffffffffffffff );
	wrapping_add_test!( 0xffffffffffffffff, 0x0000000000000001, 0x0000000000000000 );
	wrapping_add_test!( 0xffffffffffffffff, 0xffffffffffffffff, 0xfffffffffffffffe );
    }
}
