...
mod tests {
	...
	($value:expr, $result:expr) => ({
	    let x: u8 = $value;
	    let result: u8 = x.next_power_of_two();
	...
	next_power_of_two_test!( 0x00, 0x01 );
	next_power_of_two_test!( 0x01, 0x01 );
	next_power_of_two_test!( 0x03, 0x04 );
	next_power_of_two_test!( 0x05, 0x08 );
	next_power_of_two_test!( 0x09, 0x10 );
	next_power_of_two_test!( 0x11, 0x20 );
	next_power_of_two_test!( 0x21, 0x40 );
	next_power_of_two_test!( 0x41, 0x80 );
	next_power_of_two_test!( 0x81, 0x01 );
    }
}
