...
mod tests {
	...
	($value:expr, $rhs:expr, $result:expr) => ({
	    let x: u64 = $value;
	    let rhs: u64  = $rhs;
	    let result: u64 = x.wrapping_sub(rhs);
	...
	wrapping_sub_test!( 0xffffffff00000000, 0x00000000ffffffff, 0xfffffffe00000001 );
	wrapping_sub_test!( 0x0000000000000000, 0x0000000000000001, 0xffffffffffffffff );
    }
}
