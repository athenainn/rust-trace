...
mod tests {
    ...
    #[test]
    fn match_indices_test1() {
	type P<'a> = &'a str; // P: Pattern<'a>

	let x: &str = "吃葡萄不吐葡萄皮不吃葡萄倒吐葡萄皮";
	let pat: P = "葡萄皮";
	let mut result: MatchIndices<P> = x.match_indices::<P>(pat);
