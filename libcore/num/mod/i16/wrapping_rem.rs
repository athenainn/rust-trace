...
mod tests {
	...
	($value:expr, $rhs:expr, $result:expr) => ({
	    let x: i16 = $value;
	    let rhs: i16  = $rhs;
	    let result: i16 = x.wrapping_rem(rhs);
	...
	let x: i16 = 68;
	let rhs: i16  = 0;
	let _: i16 = x.wrapping_rem(rhs); // panicked at 'attempted remainder with a divisor of zero'
    }

    #[test]
    #[allow(overflowing_literals)]
    fn wrapping_rem_test2() {
	wrapping_rem_test!( 0x7fff, 0x0001, 0x0000 );
	wrapping_rem_test!( 0x7fff, 0x0002, 0x0001 );
	wrapping_rem_test!( 0x7fff, 0x0003, 0x0001 );
	wrapping_rem_test!( 0x7fff, 0x0004, 0x0003 );
	wrapping_rem_test!( 0x8000, 0xffff, 0x0000 );
    }
}
