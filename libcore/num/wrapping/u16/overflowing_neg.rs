...
mod tests {
	...
	overflowing_neg_test!( u16, 0x0000, (0x0000, always_true) );
	overflowing_neg_test!( u16, 0x0001, (0xffff, always_true) );
	overflowing_neg_test!( u16, 0x0002, (0xfffe, always_true) );
	overflowing_neg_test!( u16, 0x7fff, (0x8001, always_true) );
	overflowing_neg_test!( u16, 0x8000, (0x8000, always_true) );
    }
}
