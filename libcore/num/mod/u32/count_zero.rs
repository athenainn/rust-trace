...
mod tests {
	...
	count_zeros_test!( 0x00000001, 31 );
	count_zeros_test!( 0x00000003, 30 );
	count_zeros_test!( 0x00000007, 29 );
	count_zeros_test!( 0x0000000f, 28 );
	count_zeros_test!( 0x0000001f, 27 );
	count_zeros_test!( 0x0000003f, 26 );
	count_zeros_test!( 0x0000007f, 25 );
	count_zeros_test!( 0x000000ff, 24 );
	count_zeros_test!( 0x000001ff, 23 );
	count_zeros_test!( 0x000003ff, 22 );
	count_zeros_test!( 0x000007ff, 21 );
	count_zeros_test!( 0x00000fff, 20 );
	count_zeros_test!( 0x00001fff, 19 );
	count_zeros_test!( 0x00003fff, 18 );
	count_zeros_test!( 0x00007fff, 17 );
	count_zeros_test!( 0x0000ffff, 16 );
	count_zeros_test!( 0x0001ffff, 15 );
	count_zeros_test!( 0x0003ffff, 14 );
	count_zeros_test!( 0x0007ffff, 13 );
	count_zeros_test!( 0x000fffff, 12 );
	count_zeros_test!( 0x001fffff, 11 );
	count_zeros_test!( 0x003fffff, 10 );
	count_zeros_test!( 0x007fffff, 9 );
	count_zeros_test!( 0x00ffffff, 8 );
	count_zeros_test!( 0x01ffffff, 7 );
	count_zeros_test!( 0x03ffffff, 6 );
	count_zeros_test!( 0x07ffffff, 5 );
	count_zeros_test!( 0x0fffffff, 4 );
	count_zeros_test!( 0x1fffffff, 3 );
	count_zeros_test!( 0x3fffffff, 2 );
	count_zeros_test!( 0x7fffffff, 1 );
