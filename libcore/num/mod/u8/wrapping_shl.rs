...
mod tests {
	...
	($value:expr, $rhs:expr, $result:expr) => ({
	    let x: u8 = $value;
	    let rhs: u32  = $rhs;
	    let result: u8 = x.wrapping_shl(rhs);
	...
	wrapping_shl_test!( 0x01, 0, 0x01 );
	wrapping_shl_test!( 0x01, 1, 0x02 );
	wrapping_shl_test!( 0x01, 2, 0x04 );
	wrapping_shl_test!( 0x01, 3, 0x08 );
	wrapping_shl_test!( 0x01, 4, 0x10 );
	wrapping_shl_test!( 0x01, 5, 0x20 );
	wrapping_shl_test!( 0x01, 6, 0x40 );
	wrapping_shl_test!( 0x01, 7, 0x80 );
	wrapping_shl_test!( 0x01, 8, 0x01 );
    }
}
