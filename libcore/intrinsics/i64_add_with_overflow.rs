...
#[cfg(test)]
mod tests {
    use core::intrinsics::i64_add_with_overflow;

    // pub fn i64_add_with_overflow(x: i64, y: i64) -> (i64, bool);

    #[test]
    fn i64_add_with_overflow_test1() {
    ...
    fn i64_add_with_overflow_test2() {
    ...
    #[test]
    #[allow(overflowing_literals)]
    fn i64_add_with_overflow_test3() {
