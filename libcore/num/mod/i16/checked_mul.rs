...
mod tests {
	...
	($value:expr, $other:expr, $overflow:expr) => ({
	    let x: i16 = $value;
	    let other: i16  = $other;
	    let result: Option<i16> = x.checked_mul(other);
	...
	checked_mul_test!( 0x7fff, 0x0001, Some::<i16>(0x7fff) );
	checked_mul_test!( 0x7fff, 0x0002, None::<i16> );

	checked_mul_test!( 0x7fff, 0xffff, Some::<i16>(0x8001) );
	checked_mul_test!( 0x8000, 0xffff, None::<i16> );
    }
}
