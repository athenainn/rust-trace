...
mod tests {
	...
	if cfg!(target_pointer_width = "64") {
	    overflowing_neg_test!( usize, 0x0000000000000000, (0x0000000000000000, always_true) );
	    overflowing_neg_test!( usize, 0x0000000000000001, (0xffffffffffffffff, always_true) );
	    overflowing_neg_test!( usize, 0x0000000000000002, (0xfffffffffffffffe, always_true) );
	    overflowing_neg_test!( usize, 0x7fffffffffffffff, (0x8000000000000001, always_true) );
	    overflowing_neg_test!( usize, 0x8000000000000000, (0x8000000000000000, always_true) );
	} else {
	    overflowing_neg_test!( usize, 0x00000000, (0x00000000, always_true) );
	    overflowing_neg_test!( usize, 0x00000001, (0xffffffff, always_true) );
	    overflowing_neg_test!( usize, 0x00000002, (0xfffffffe, always_true) );
	    overflowing_neg_test!( usize, 0x7fffffff, (0x80000001, always_true) );
	    overflowing_neg_test!( usize, 0x80000000, (0x80000000, always_true) );
	}
    }
}
