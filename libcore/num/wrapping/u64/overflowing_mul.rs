...
mod tests {
	...
	overflowing_mul_test!( u64, 0xffffffffffffffff, 0x0000000000000001, (0xffffffffffffffff, false) );
	overflowing_mul_test!( u64, 0xffffffffffffffff, 0x0000000000000002, (0xfffffffffffffffe, true) );
    }
}
