...
mod tests {
	...
	($value:expr, $rhs:expr, $result:expr) => ({
	    let x: i64 = $value;
	    let rhs: i64  = $rhs;
	    let result: i64 = x.wrapping_div(rhs);
	...
	let x: i64 = 68;
	let rhs: i64  = 0;
	let _: i64 = x.wrapping_div(rhs); // panicked at 'attempted to divide by zero'
    }

    #[test]
    #[allow(overflowing_literals)]
    fn wrapping_div_test2() {
	wrapping_div_test!( 0x7fffffffffffffff, 0x0000000000000001, 0x7fffffffffffffff );
	wrapping_div_test!( 0x7fffffffffffffff, 0xffffffffffffffff, 0x8000000000000001 );
	wrapping_div_test!( 0x8000000000000000, 0xffffffffffffffff, 0x8000000000000000 );
    }
}
