...
mod tests {
	...
	let mut char_indices: CharIndices = x.char_indices();

	assert_eq!(char_indices.next_back(), Some::<(usize, char)>((33, '。')));
	assert_eq!(char_indices.next_back(), Some::<(usize, char)>((30, '體')));
	assert_eq!(char_indices.next_back(), Some::<(usize, char)>((27, '身')));
	assert_eq!(char_indices.next_back(), Some::<(usize, char)>((24, '傷')));
	assert_eq!(char_indices.next_back(), Some::<(usize, char)>((21, '不')));
	assert_eq!(char_indices.next_back(), Some::<(usize, char)>((18, '而')));
	assert_eq!(char_indices.next_back(), Some::<(usize, char)>((15, '璃')));
	assert_eq!(char_indices.next_back(), Some::<(usize, char)>((12, '玻')));
	assert_eq!(char_indices.next_back(), Some::<(usize, char)>((9, '下')));
	assert_eq!(char_indices.next_back(), Some::<(usize, char)>((6, '吞')));
	assert_eq!(char_indices.next_back(), Some::<(usize, char)>((3, '能')));
	assert_eq!(char_indices.next_back(), Some::<(usize, char)>((0, '我')));
	assert_eq!(char_indices.next_back(), None::<(usize, char)>);
    }
}
