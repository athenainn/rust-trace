...
mod tests {
	...
	($value:expr, $rhs:expr, $result:expr) => ({
	    let x: u32 = $value;
	    let rhs: u32  = $rhs;
	    let result: u32 = x.wrapping_rem(rhs);
	...
	let x: u32 = 68;
	let rhs: u32  = 0;
	let _: u32 = x.wrapping_rem(rhs); // panicked at 'attempted remainder with a divisor of zero'
    }

    #[test]
    fn wrapping_rem_test2() {
	wrapping_rem_test!( 0xffffffff, 0x00000001, 0x00000000 );
	wrapping_rem_test!( 0xffffffff, 0x00000002, 0x00000001 );
	wrapping_rem_test!( 0xffffffff, 0x00000003, 0x00000000 );
	wrapping_rem_test!( 0xffffffff, 0x00000004, 0x00000003 );
    }
}
