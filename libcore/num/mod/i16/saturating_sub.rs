...
mod tests {
	...
	($value:expr, $other:expr, $result:expr) => ({
	    let x: i16 = $value;
	    let other: i16  = $other;
	    let result: i16 = x.saturating_sub(other);
	...
	saturating_sub_test!( 0x7f00, 0x00ff, 0x6e01 );
	saturating_sub_test!( 0x7fff, 0xffff, 0x7fff );
	saturating_sub_test!( 0x8000, 0x0001, 0x8000 );
    }
}
