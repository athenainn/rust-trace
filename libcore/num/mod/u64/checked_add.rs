...
mod tests {
	...
	($value:expr, $other:expr, $overflow:expr) => ({
	    let x: u64 = $value;
	    let other: u64  = $other;
	    let result: Option<u64> = x.checked_add(other);
	...
	checked_add_test!( 0xffffffff00000000, 0x00000000ffffffff, Some::<u64>(0xffffffffffffffff) );
	checked_add_test!( 0xffffffffffffffff, 0x0000000000000001, None::<u64> );
    }
}
