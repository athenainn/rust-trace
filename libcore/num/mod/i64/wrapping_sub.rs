...
mod tests {
    ...
    macro_rules! wrapping_sub_test {
	($value:expr, $rhs:expr, $result:expr) => ({
	    let x: i64 = $value;
	    let rhs: i64  = $rhs;
	    let result: i64 = x.wrapping_sub(rhs);
    ...
    fn wrapping_sub_test1() {
	wrapping_sub_test!( 0x7fffffff00000000, 0x00000000ffffffff, 0x7ffffffe00000001 );
	wrapping_sub_test!( 0x8000000000000000, 0x0000000000000001, 0x7fffffffffffffff );
	wrapping_sub_test!( 0x7fffffffffffffff, 0xffffffffffffffff, 0x8000000000000000 );
    }
}
