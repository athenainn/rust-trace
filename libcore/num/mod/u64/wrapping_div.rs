...
mod tests {
	...
	($value:expr, $rhs:expr, $result:expr) => ({
	    let x: u64 = $value;
	    let rhs: u64  = $rhs;
	    let result: u64 = x.wrapping_div(rhs);
	...
	let x: u64 = 68;
	let rhs: u64  = 0;
	let _: u64 = x.wrapping_div(rhs); // panicked at 'attempted to divide by zero'
    }

    #[test]
    fn wrapping_div_test2() {
	wrapping_div_test!( 0xffffffffffffffff, 0x0000000000000001, 0xffffffffffffffff );
	wrapping_div_test!( 0xffffffffffffffff, 0x0000000000000002, 0x7fffffffffffffff );
	wrapping_div_test!( 0xffffffffffffffff, 0x0000000000000003, 0x5555555555555555 );
    }
}
