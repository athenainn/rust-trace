...
mod tests {
	...
	overflowing_add_test!( u64, 0xffffffff00000000, 0x00000000ffffffff, (0xffffffffffffffff, false) );
	overflowing_add_test!( u64, 0xffffffffffffffff, 0x0000000000000001, (0x0000000000000000, true) );
    }
}
