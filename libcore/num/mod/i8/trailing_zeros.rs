...
mod tests {
	...
	trailing_zeros_test!( 0x00, 8 );
	trailing_zeros_test!( 0x01, 0 );
	trailing_zeros_test!( 0x02, 1 );
	trailing_zeros_test!( 0x04, 2 );
	trailing_zeros_test!( 0x08, 3 );
	trailing_zeros_test!( 0x10, 4 );
	trailing_zeros_test!( 0x20, 5 );
	trailing_zeros_test!( 0x40, 6 );
	trailing_zeros_test!( 0x80, 7 );
    }
}
