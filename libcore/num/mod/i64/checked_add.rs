...
mod tests {
    ...
    macro_rules! checked_add_test {
	($value:expr, $other:expr, $overflow:expr) => ({
	    let x: i64 = $value;
	    let other: i64  = $other;
	    let result: Option<i64> = x.checked_add(other);
    ...
    fn checked_add_test1() {
	checked_add_test!( 0x7fffffff00000000, 0x00000000ffffffff, Some::<i64>(0x7fffffffffffffff) );
	checked_add_test!( 0x7fffffffffffffff, 0x0000000000000001, None::<i64> );
	checked_add_test!( 0x8000000000000000, 0xffffffffffffffff, None::<i64> );
    }
}
