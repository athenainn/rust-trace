...
mod tests {
	...
	($value:expr, $v:expr, $overflow:expr) => ({
	    let x: u64 = $value;
	    let v: u64  = $v;
	    let result: Option<u64> = x.checked_div(v);
	...
	checked_div_test!( 0xffffffff00000000, 0x00000000ffffffff, Some::<u64>(0x0000000100000000) );
	checked_div_test!( 0xffffffffffffffff, 0x0000000000000000, None::<u64> );
    }
}
