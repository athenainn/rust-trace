...
mod tests {
	...
	($init:expr, $val:expr, $order:ident, $result:expr) => ({
		...
		let result: usize = clone.fetch_add(val, $order);
		assert_eq!(result, $init);
	    });
    ...
    #[test]
    fn fetch_add_test4() {
	fetch_add_test!( !0, !0, Relaxed, !0 -1 );
	fetch_add_test!( !0, !0, Release, !0 -1 );
	fetch_add_test!( !0, !0, Acquire, !0 -1 );
	fetch_add_test!( !0, !0, AcqRel, !0 -1 );
	fetch_add_test!( !0, !0, SeqCst, !0 -1 );
    }
}
