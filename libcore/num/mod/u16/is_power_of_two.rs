...
mod tests {
	...
	is_power_of_two_test!( 0x0001, true );
	is_power_of_two_test!( 0x0002, true );
	is_power_of_two_test!( 0x0004, true );
	is_power_of_two_test!( 0x0008, true );
	is_power_of_two_test!( 0x0010, true );
	is_power_of_two_test!( 0x0020, true );
	is_power_of_two_test!( 0x0040, true );
	is_power_of_two_test!( 0x0080, true );
	is_power_of_two_test!( 0x0100, true );
	is_power_of_two_test!( 0x0200, true );
	is_power_of_two_test!( 0x0400, true );
	is_power_of_two_test!( 0x0800, true );
	is_power_of_two_test!( 0x1000, true );
	is_power_of_two_test!( 0x2000, true );
	is_power_of_two_test!( 0x4000, true );
	is_power_of_two_test!( 0x8000, true );
    }
}
