...
mod tests {
	...
	($value:expr, $other:expr, $overflow:expr) => ({
	    let x: i16 = $value;
	    let other: i16  = $other;
	    let result: Option<i16> = x.checked_sub(other);
	...
	checked_sub_test!( 0x7f00, 0x00ff, Some::<i16>(0x7e01) );
	checked_sub_test!( 0x7fff, 0xffff, None::<i16> );
	checked_sub_test!( 0x8000, 0x0001, None::<i16> );
    }
}
