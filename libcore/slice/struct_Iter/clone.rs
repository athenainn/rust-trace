...
mod tests {
	...
	assert_eq!(iter.next(), Some::<&T>(&11));
	assert_eq!(iter.next(), Some::<&T>(&12));
	assert_eq!(iter.next(), Some::<&T>(&12));
	assert_eq!(iter.next(), Some::<&T>(&13));
	assert_eq!(iter.next(), Some::<&T>(&14));
	assert_eq!(iter.next(), Some::<&T>(&15));
	assert_eq!(iter.next(), Some::<&T>(&16));
