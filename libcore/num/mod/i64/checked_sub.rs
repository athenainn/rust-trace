...
mod tests {
    ...
    macro_rules! checked_sub_test {
	($value:expr, $other:expr, $overflow:expr) => ({
	    let x: i64 = $value;
	    let other: i64  = $other;
	    let result: Option<i64> = x.checked_sub(other);
    ...
    fn checked_sub_test1() {
	checked_sub_test!( 0x7fffffff00000000, 0x00000000ffffffff, Some::<i64>(0x7ffffffe00000001) );
	checked_sub_test!( 0x7fffffffffffffff, 0xffffffffffffffff, None::<i64> );
	checked_sub_test!( 0x8000000000000000, 0x0000000000000001, None::<i64> );
    }
}
