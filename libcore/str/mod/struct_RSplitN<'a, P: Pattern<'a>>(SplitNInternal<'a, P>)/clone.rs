...
mod tests {
	...
	let count: usize = 3;
	let pat: P = "葡萄皮";
	let mut rsplitn: RSplitN<P> = x.rsplitn::<P>(count, pat);
	let mut clone: RSplitN<P> = rsplitn.clone();

	assert_eq!(rsplitn.next(), Some::<&str>(""));
	assert_eq!(rsplitn.next(), Some::<&str>("不吃葡萄倒吐"));
	assert_eq!(rsplitn.next(), Some::<&str>("吃葡萄不吐"));
	assert_eq!(rsplitn.next(), None::<&str>);
	...
	assert_eq!(rsplitn.next(), Some::<&str>("葡萄倒吐葡萄皮"));
	assert_eq!(rsplitn.next(), Some::<&str>("葡萄不吐葡萄皮不"));
	assert_eq!(rsplitn.next(), Some::<&str>(""));
	assert_eq!(rsplitn.next(), None::<&str>);

	assert_eq!(clone.next(), Some::<&str>("葡萄倒吐葡萄皮"));
	assert_eq!(clone.next(), Some::<&str>("葡萄不吐葡萄皮不"));
	assert_eq!(clone.next(), Some::<&str>(""));
	assert_eq!(clone.next(), None::<&str>);
    }
	...
	assert_eq!(rsplitn.next(), Some::<&str>("葡萄倒吐葡萄皮"));
	assert_eq!(rsplitn.next(), Some::<&str>(""));
	assert_eq!(rsplitn.next(), Some::<&str>("吃葡萄不吐葡萄皮"));
	assert_eq!(rsplitn.next(), None::<&str>);

	assert_eq!(clone.next(), Some::<&str>("葡萄倒吐葡萄皮"));
	assert_eq!(clone.next(), Some::<&str>(""));
	assert_eq!(clone.next(), Some::<&str>("吃葡萄不吐葡萄皮"));
	assert_eq!(clone.next(), None::<&str>);
    }
	...
	assert_eq!(rsplitn.next(), Some::<&str>("倒吐葡萄皮"));
	assert_eq!(rsplitn.next(), Some::<&str>("不吐葡萄皮不"));
	assert_eq!(rsplitn.next(), Some::<&str>(""));
	assert_eq!(rsplitn.next(), None::<&str>);

	assert_eq!(clone.next(), Some::<&str>("倒吐葡萄皮"));
	assert_eq!(clone.next(), Some::<&str>("不吐葡萄皮不"));
	assert_eq!(clone.next(), Some::<&str>(""));
	assert_eq!(clone.next(), None::<&str>);
    }
}
