...
mod tests {
    ...
    macro_rules! is_positive_test {
	($value:expr, $result:expr) => ({
	    let x: i64 = $value;
	    let result: bool = x.is_positive();
    ...
    fn is_positive_test1() {
	is_positive_test!( 0x7fffffffffffffff, true );
	is_positive_test!( 0x0000000000000001, true );
	is_positive_test!( 0x0000000000000000, false );
	is_positive_test!( 0x8000000000000000, false );
	is_positive_test!( 0xffffffffffffffff, false );
    }
}
