...
mod tests {
	...
	let pat: P = "葡萄皮";
	let mut match_indices: MatchIndices<P> = x.match_indices::<P>::<P>(pat);
	let mut clone: MatchIndices<P> = match_indices.clone();

	assert_eq!(match_indices.next(), Some::<(usize, usize)>((15, 24)));
	assert_eq!(match_indices.next(), Some::<(usize, usize)>((42, 51)));
	assert_eq!(match_indices.next(), None::<(usize, usize)>);
	...
	assert_eq!(match_indices.next(), Some::<(usize, usize)>((21, 24)));
	assert_eq!(match_indices.next(), Some::<(usize, usize)>((48, 51)));
	assert_eq!(match_indices.next(), None::<(usize, usize)>);
	...
	assert_eq!(match_indices.next(), Some::<(usize, usize)>((9, 12)));
	assert_eq!(match_indices.next(), Some::<(usize, usize)>((21, 24)));
	assert_eq!(match_indices.next(), Some::<(usize, usize)>((24, 27)));
	assert_eq!(match_indices.next(), Some::<(usize, usize)>((48, 51)));
	assert_eq!(match_indices.next(), None::<(usize, usize)>);
