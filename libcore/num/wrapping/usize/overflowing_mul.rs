...
mod tests {
	...
	if cfg!(target_pointer_width = "64") {
	    overflowing_mul_test!( usize, 0xffffffffffffffff, 0x0000000000000001, (0xffffffffffffffff, false) );
	    overflowing_mul_test!( usize, 0xffffffffffffffff, 0x0000000000000002, (0xfffffffffffffffe, true) );
	} else {
	    overflowing_mul_test!( usize, 0xffffffff, 0x00000001, (0xffffffff, false) );
	    overflowing_mul_test!( usize, 0xffffffff, 0x00000002, (0xfffffffe, true) );
	}
    }
}
