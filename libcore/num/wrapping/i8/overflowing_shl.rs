...
mod tests {
	...
	overflowing_shl_test!( i8, 0x01, 0, (0x01, false) );
	overflowing_shl_test!( i8, 0x01, 1, (0x02, false) );
	overflowing_shl_test!( i8, 0x01, 2, (0x04, false) );
	overflowing_shl_test!( i8, 0x01, 3, (0x08, false) );
	overflowing_shl_test!( i8, 0x01, 4, (0x10, false) );
	overflowing_shl_test!( i8, 0x01, 5, (0x20, false) );
	overflowing_shl_test!( i8, 0x01, 6, (0x40, false) );
	overflowing_shl_test!( i8, 0x01, 7, (0x80, false) );
	overflowing_shl_test!( i8, 0x01, 8, (0x01, true) );
    }
}
