...
#[cfg(test)]
mod tests {
    use core::intrinsics::atomic_umax_acqrel;
    ...
    macro_rules! atomic_umax_acqrel_test {
	($init:expr, $value:expr, $result:expr) => ({
		...
		let src: T = $value;
		let old: T = unsafe { atomic_umax_acqrel::<T>(dst, src) };
    ...
    #[test]
    fn atomic_umax_acqrel_test1() {
	atomic_umax_acqrel_test!( !0, 0, !0 );
    }
}
