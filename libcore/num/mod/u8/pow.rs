...
mod tests {
    ...
    #[test]
    fn pow_test1() {
	pow_test!( 0x02, 0, 0x01 );
	pow_test!( 0x02, 1, 0x02 );
	pow_test!( 0x02, 2, 0x04 );
	pow_test!( 0x02, 3, 0x08 );
	pow_test!( 0x02, 4, 0x10 );
	pow_test!( 0x02, 5, 0x20 );
	pow_test!( 0x02, 6, 0x40 );
	pow_test!( 0x02, 7, 0x80 );
    }

    #[test]
    #[should_panic]
    fn pow_test2() {
	pow_test!( 0x02, 8, 0x00 ); // panicked at 'arithmetic operation overflowed'
    }
}
