...
mod tests {
	...
	is_negative_test!( 0x7fffffff, false );
	is_negative_test!( 0x00000001, false );
	is_negative_test!( 0x00000000, false );
	is_negative_test!( 0x80000000, true );
	is_negative_test!( 0xffffffff, true );
    }
}
