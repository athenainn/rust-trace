...
mod tests {
	...
	($value:expr, $other:expr, $overflow:expr) => ({
	    let x: u64 = $value;
	    let other: u64  = $other;
	    let result: Option<u64> = x.checked_sub(other);
	...
	checked_sub_test!( 0xffffffff00000000, 0x00000000ffffffff, Some::<u64>(0xfffffffe00000001) );
	checked_sub_test!( 0x0000000000000000, 0x0000000000000001, None::<u64> );
    }
}
