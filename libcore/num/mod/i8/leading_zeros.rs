...
mod tests {
	...
	leading_zeros_test!( 0x00, 8 );
	leading_zeros_test!( 0x01, 7 );
	leading_zeros_test!( 0x03, 6 );
	leading_zeros_test!( 0x07, 5 );
	leading_zeros_test!( 0x0f, 4 );
	leading_zeros_test!( 0x1f, 3 );
	leading_zeros_test!( 0x3f, 2 );
	leading_zeros_test!( 0x7f, 1 );
	leading_zeros_test!( 0xff, 0 );
    }
}
