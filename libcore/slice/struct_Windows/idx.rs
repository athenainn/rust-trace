...
mod tests {
	...
	assert_eq!(windows.idx(6), Some::<&[T]>(&[16]));
	assert_eq!(windows.idx(7), None::<&[T]>);
    }
	...
	assert_eq!(windows.idx(5), Some::<&[T]>(&[15, 16]));
	assert_eq!(windows.idx(6), None::<&[T]>);
    }
	...
	assert_eq!(windows.idx(4), Some::<&[T]>(&[14, 15, 16]));
	assert_eq!(windows.idx(5), None::<&[T]>);
    }
	...
	assert_eq!(windows.idx(3), Some::<&[T]>(&[13, 14, 15, 16]));
	assert_eq!(windows.idx(4), None::<&[T]>);
    }
	...
	assert_eq!(windows.idx(2), Some::<&[T]>(&[12, 13, 14, 15, 16]));
	assert_eq!(windows.idx(3), None::<&[T]>);
    }
	...
	assert_eq!(windows.idx(1), Some::<&[T]>(&[12, 12, 13, 14, 15, 16]));
	assert_eq!(windows.idx(2), None::<&[T]>);
    }
	...
	assert_eq!(windows.idx(0), Some::<&[T]>(&[11, 12, 12, 13, 14, 15, 16]));
	assert_eq!(windows.idx(1), None::<&[T]>);
    }
	...
	assert_eq!(windows.idx(0), None::<&[T]>);
    }
}
