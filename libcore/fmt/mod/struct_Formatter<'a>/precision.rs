...
mod tests {
	...
	fn fmt(&self, fmt: &mut Formatter) -> Result {
	    let precision: Option<usize> = fmt.precision();
	    let msg: String = match precision {
		Some(p) => format!("{}", p),
		None => "None".to_string()
	    };
	...
	assert_eq!(output, "None".to_string());
    }
    ...
    fn precision_test3() {
	let a: A<T> = A::new();
	let asterisk: usize = 68;
	let output: String = format!("{:.*}", asterisk, a);
