...
#[cfg(test)]
mod tests {
    use core::intrinsics::atomic_min_relaxed;
    ...
    macro_rules! atomic_min_relaxed_test {
	($init:expr, $value:expr, $result:expr) => ({
		...
		let src: T = $value;
		let old: T = unsafe { atomic_min_relaxed::<T>(dst, src) };
    ...
    #[test]
    fn atomic_min_relaxed_test1() {
	atomic_min_relaxed_test!( !0, 0, !0 );
    }
}
