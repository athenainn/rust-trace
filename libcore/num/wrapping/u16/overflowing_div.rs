...
mod tests {
	...
	overflowing_div_test!( u16, 0xffff, 0x0001, (0xffff, always_false) );
	overflowing_div_test!( u16, 0xffff, 0x0002, (0x7fff, always_false) );
    }
	...
	overflowing_div_test!( u16, 0xffff, 0x0000, (0xffff, always_false) ); // panicked at 'attempted to divide by zero'
    }
}
