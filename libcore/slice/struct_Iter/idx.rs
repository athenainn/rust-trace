...
mod tests {
	...
	assert_eq!(iter.idx(0), Some::<&T>(&11));
	assert_eq!(iter.idx(1), Some::<&T>(&12));
	assert_eq!(iter.idx(2), Some::<&T>(&12));
	assert_eq!(iter.idx(3), Some::<&T>(&13));
	assert_eq!(iter.idx(4), Some::<&T>(&14));
	assert_eq!(iter.idx(5), Some::<&T>(&15));
	assert_eq!(iter.idx(6), Some::<&T>(&16));
	assert_eq!(iter.idx(7), None::<&T>);
    }
}
