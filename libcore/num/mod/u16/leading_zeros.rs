...
mod tests {
	...
	leading_zeros_test!( 0x0000, 16 );
	leading_zeros_test!( 0x0001, 15 );
	leading_zeros_test!( 0x0003, 14 );
	leading_zeros_test!( 0x0007, 13 );
	leading_zeros_test!( 0x000f, 12 );
	leading_zeros_test!( 0x001f, 11 );
	leading_zeros_test!( 0x003f, 10 );
	leading_zeros_test!( 0x007f, 9 );
	leading_zeros_test!( 0x00ff, 8 );
	leading_zeros_test!( 0x01ff, 7 );
	leading_zeros_test!( 0x03ff, 6 );
	leading_zeros_test!( 0x07ff, 5 );
	leading_zeros_test!( 0x0fff, 4 );
	leading_zeros_test!( 0x1fff, 3 );
	leading_zeros_test!( 0x3fff, 2 );
	leading_zeros_test!( 0x7fff, 1 );
	leading_zeros_test!( 0xffff, 0 );
    }
}
