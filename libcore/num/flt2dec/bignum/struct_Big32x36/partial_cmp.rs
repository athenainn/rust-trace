...
mod tests {
	...
	let big: Big32x36 = Big32x36::from_small(v1);

	let v2: Digit32 = 0xfedcba98;
	let other: Big32x36 = Big32x36::from_small(v2);

	let result: Option<Ordering> = big.partial_cmp(&other);
	...
	let big: Big32x36 = Big32x36::from_small(v);
	...
	let v1: Digit32 = 0xfedcba98;
	let big: Big32x36 = Big32x36::from_small(v1);

	let v2: Digit32 = 0x12345678;
	let other: Big32x36 = Big32x36::from_small(v2);
