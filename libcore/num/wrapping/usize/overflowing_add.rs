...
mod tests {
	...
	if cfg!(target_pointer_width = "64") {
	    overflowing_add_test!( usize, 0xffffffff00000000, 0x00000000ffffffff, (0xffffffffffffffff, false) );
	    overflowing_add_test!( usize, 0xffffffffffffffff, 0x0000000000000001, (0x0000000000000000, true) );
	} else {
	    overflowing_add_test!( usize, 0xffff0000, 0x0000ffff, (0xffffffff, false) );
	    overflowing_add_test!( usize, 0xffffffff, 0x00000001, (0x00000000, true) );
	}
    }
}
