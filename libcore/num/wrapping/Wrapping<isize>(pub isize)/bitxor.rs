...
mod tests {
	...
	($T:ty, $value:expr, $other:expr, $result:expr) => ({
	    ...
	    let result: Wrapping<$T> = wrapping_value.bitxor(wrapping_other);
	...
	if cfg!(target_pointer_width = "64") {
	    bitxor_test!( isize, 0xe7e7e7e7e7e7e7e7, 0x7e7e7e7e7e7e7e7e, 0x9999999999999999 );
	} else {
	    bitxor_test!( isize, 0xe7e7e7e7, 0x7e7e7e7e, 0x99999999 );
	}
    }
}
