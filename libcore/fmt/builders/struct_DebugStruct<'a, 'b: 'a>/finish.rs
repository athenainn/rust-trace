...
mod tests {
	...
	fn fmt(&self, fmt: &mut Formatter) -> Result {
	    ...
	    let mut debugstruct: DebugStruct = fmt.debug_struct(name);

	    let debugstruct_refmut: &mut DebugStruct = debugstruct.field("value", &self.value);
	    let result: Result = debugstruct_refmut.finish();
