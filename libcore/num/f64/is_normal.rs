...
mod tests {
	...
	assert_eq!(value.is_finite(), false);
    }
	...
	assert_eq!(value.is_normal(), false);
    }
	...
	unsafe {
	    *(&mut value as *const f64 as *mut u64) =
		0b0_00000000000_1111111111111111111111111111111111111111111111111111;
	}
    ...
    #[test]
    fn is_normal_test5() {
	let value: f64 = 68_f64;

	assert_eq!(value.is_normal(), true);
    }
}
