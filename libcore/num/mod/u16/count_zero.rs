...
mod tests {
	...
	count_zeros_test!( 0x0000, 16 );
	count_zeros_test!( 0x0001, 15 );
	count_zeros_test!( 0x0003, 14 );
	count_zeros_test!( 0x0007, 13 );
	count_zeros_test!( 0x000f, 12 );
	count_zeros_test!( 0x001f, 11 );
	count_zeros_test!( 0x003f, 10 );
	count_zeros_test!( 0x007f, 9 );
	count_zeros_test!( 0x00ff, 8 );
	count_zeros_test!( 0x01ff, 7 );
	count_zeros_test!( 0x03ff, 6 );
	count_zeros_test!( 0x07ff, 5 );
	count_zeros_test!( 0x0fff, 4 );
	count_zeros_test!( 0x1fff, 3 );
	count_zeros_test!( 0x3fff, 2 );
	count_zeros_test!( 0x7fff, 1 );
