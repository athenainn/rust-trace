...
mod tests {
	...
	let result: Result<i64, ParseIntError> = i64::from_str(src);

	assert_eq!(result, Ok::<i64, ParseIntError>(68));
    }
    ...
    #[test]
    fn from_str_test5() {
	let src: &'static str = "9223372036854775808";
	let result: Result<i64, ParseIntError> = i64::from_str(src);
    ...
    #[test]
    fn from_str_test6() {
	let src: &'static str = "-9223372036854775809";
	let result: Result<i64, ParseIntError> = i64::from_str(src);
